...
class __Mustache_54c2df8d506e1f5123c88d670fd3d616 extends Mustache_Template
{
...
';
        ...
        $value = $context->find('hasrecentactivities');
        $buffer .= $this->section06dc22df522a023373601871b53ee7a5($context, $indent, $value);
        $buffer .= $indent . '</div>
';
...
';
    ...
    private function section06dc22df522a023373601871b53ee7a5(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '
';
                $buffer .= $indent . '        <table class="xp-w-full xp-border-0 table-reboot">
';
                $value = $context->find('recentactivities');
