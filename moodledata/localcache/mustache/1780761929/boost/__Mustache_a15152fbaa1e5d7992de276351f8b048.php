...
class __Mustache_a15152fbaa1e5d7992de276351f8b048 extends Mustache_Template
{
...
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '    <div class="xp-my-3">';
...
';
        ...
        $buffer .= $this->section7d69514fa1c2ecc1d82c4dba450d64c9($context, $indent, $value);
        $buffer .= $indent . '
';
...
';
    ...
    private function section2fc32eb51144b43ba18710b65ff90768(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            $source = '
                        {{^highlight}}
                        <div class="xp-text-2xs xp-text-gray-500 xp-mt-1" title="{{diff}}">
            ...
            foreach ($values as $value) {
                ...
                if (empty($value)) {
                    ...
                    $buffer .= $indent . '                        <div class="xp-text-2xs xp-text-gray-500 xp-mt-1" title="';
                    $value = $this->resolveValue($context->find('diff'), $context);
                    $buffer .= ($value === null ? '' : call_user_func($this->mustache->getEscape(), $value));
                    $buffer .= '">
';
...
';
    ...
    private function section9650647c65f5b9a0d0029214a464e214(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->section2fc32eb51144b43ba18710b65ff90768($context, $indent, $value);
                $buffer .= $indent . '                    </div>
';
                $context->pop();
            }
    ...
    private function section67c8e8dd57bc46516ebe445d1388afa3(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                $value = $context->find('rankingsnapshot');
                $buffer .= $this->section9650647c65f5b9a0d0029214a464e214($context, $indent, $value);
                $buffer .= $indent . '            </div>
';
                $context->pop();
            }
    ...
    private function section7d69514fa1c2ecc1d82c4dba450d64c9(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->section67c8e8dd57bc46516ebe445d1388afa3($context, $indent, $value);
                $buffer .= $indent . '
';
                $buffer .= $indent . '        </div>
';
