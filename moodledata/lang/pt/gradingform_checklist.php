...
/**
 * Strings for component 'gradingform_checklist', language 'pt', version '4.4'.
 *
...
$string['maxlengthalert'] = 'Este campo de entrada tem um comprimento máximo de {$a} caracteres';
$string['name'] = 'Nome';
