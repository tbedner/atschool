...
/**
 * Strings for component 'block_enrolmenttimer', language 'pt', version '4.4'.
 *
...
$string['activecountdown_help'] = 'Contagem decrescente ativa do tempo restante que o aluno tem para aceder à disciplina usando javascript';
...
$string['displayNothingNoDateSet_help'] = 'Ocultar o bloco aos utilizadores que não têm data final definida. Se desativada, será mostrada uma mensagem aos alunos';
...
$string['emailsubject_help'] = 'Assunto do e-mail que será enviado ao utilizador';
...
$string['viewoptions'] = 'Incrementos a mostrar';
$string['viewoptions_desc'] = 'Selecione os incrementos a mostrar no bloco';
