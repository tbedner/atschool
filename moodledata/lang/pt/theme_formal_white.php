...
/**
 * Strings for component 'theme_formal_white', language 'pt', version '4.4'.
 *
...
$string['ctmo_onfrontpageonly'] = 'apenas na página principal';
...
$string['fontsizereferencedesc'] = 'Esta opção permite definir o tamanho predefinido da fonte para este tema. Não é recomendado que o tamanho seja superior a 13px, pois causa problemas de visualização com certos blocos.';
...
$string['frontpagelogourl'] = 'Logótipo personalizado da página principal';
$string['frontpagelogourldesc'] = 'Altere o logótipo que será exibido na página principal do seu site inserindo o URL, completo ou relativo, da imagem que deseja usar (exemplo: http://www.seusite.tld/meulogo.png ou ../caminho/para/seu/logo.png). Esta configuração substitui a configuração logótipo personalizado. Como referência, o logótipo padrão tem 300px de largura, 80px de altura e funcionará melhor se for um png transparente.';
