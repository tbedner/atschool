...
/**
 * Strings for component 'theme_boost_union', language 'pt', version '4.4'.
 *
...
$string['accessibilitydeclarationlinkpositionnone'] = 'Não mostrar automaticamente uma hiperligação para a página de declaração de acessibilidade.';
...
$string['categorylistingpresentation_nochange'] = 'Pesadelo do designer (inalterado conforme apresentado pelo core do Moodle)';
...
$string['courselistingpresentation'] = 'Apresentação da lista de disciplinas';
...
$string['courselistingpresentation_nochange'] = 'Pesadelo do designer (inalterado conforme apresentado pelo core do Moodle)';
...
$string['enableaccessibilitydeclarationsetting_desc'] = 'Com esta configuração, pode ativar uma página para a declaração de acessibilidade. Comportar-se-á exatamente como as <a href="{$a->url}">outras páginas estáticas</a> no Boost Union.';
$string['enableaccessibilitysupportfooterbuttonsetting'] = 'Ativar botão de rodapé de suporte à acessibilidade';
...
$string['flavoursbackgroundimageposition_help'] = 'Com esta configuração, irá substituir a posição da imagem de fundo, que é configurada nas opções da aparência do Boost Union.';
