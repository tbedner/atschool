...
/**
 * Strings for component 'qtype_geogebra', language 'bg', version '4.4'.
 *
...
$string['dragndrop'] = 'Придърпайте и пуснете файл от GeoGebra където и да е в секцията на  Аплета GeoGebra';
$string['enable_label_drags'] = 'Разрешаване на придърпване на етикети';
$string['enable_right_click'] = 'Разрешаване на щракване с десен бутон на мишката и редакция от клавиатурата';
...
$string['feedback_help'] = 'Обратна връзка се получава автоматично от надписа на променливата във  файла на GeoGebra.';
$string['geogebraapplet'] = 'Аплет GeoGebra';
$string['getvars'] = 'Получаване на променливи, които могат да бъдат направени произволни от аплета';
$string['ggbfilemissing'] = 'Низът base64 в отговора липсва. Вероятно JavaScript не е включен в браузъра или е възникнала неизвестна грешка';
$string['ggbturl'] = 'URL или ID на  работен лист на GeoGebra';
...
$string['mineqmax'] = 'Минимумът и максимумът за рандомизацията не са зададени правилно за променлицата {$a}. Или не сте задали минимум или максимум на слайдера, или елементът изобщо не е слайдер. Може би трябва да поправите това във Вашия файл от GeoGebra.';
$string['minplusstepgtmax'] = 'Минимумът плюс инкремента е по-голям от максимума за променливата {$a}. Може би трябва да коригирате това във Вашия файл от GeoGebra.';
...
$string['pluginname_help'] = 'Въпроси, на които обучаваният да отговори, използвайки GeoGebra';
