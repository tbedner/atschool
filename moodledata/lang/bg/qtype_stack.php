...
/**
 * Strings for component 'qtype_stack', language 'bg', version '4.4'.
 *
 * @package     qtype_stack
 * @category    string
...
$string['defaultprtincorrectfeedback'] = 'Неправилен отговор.';
$string['deletetestcaseareyousure'] = 'Сигурни ли сте, че искате да изтриете тестовия случай {$a->no} на въпроса {$a->question}?';
...
$string['penaltyerror'] = 'Наказанието трябва да бъде цифрова стойност между 0 и 1.';
$string['pleaseananswerallparts'] = 'Моля, отговорете на всички части на въпроса.';
$string['pluginname_help'] = 'STACK е система за задания по математика.';
...
$string['questiontextnonempty'] = 'Текста на въпроса не може да бъде пълен.';
$string['questionvaluepostive'] = 'Стойността на въпроса трябва да бъде неотрицателна.';
...
$string['scoreerror'] = 'Оценката трябва да бъде числова стойност между 0 и 1.';
