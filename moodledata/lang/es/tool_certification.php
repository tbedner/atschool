...
/**
 * Strings for component 'tool_certification', language 'es', version '4.4'.
 *
...
$string['allocatetocertifications'] = 'Asignar a certificaciones...';
$string['allocateusers'] = 'Asignar usuarios';
$string['allocateuserstocertification'] = 'Asignar usuarios a certificaciones...';
$string['allocationdate'] = 'Fecha de asignación';
$string['allocationdateisonorafter'] = 'Fecha de asignación en o después de';
$string['allocationdefaultvalue'] = 'La misma que se define en las certificaciones (predeterminada)';
...
$string['certificationdates'] = 'Fechas';
$string['certificationdates_help'] = 'Selecciona las fechas aplicables a esta asignación de certificación:

* **Igual que la definida en las certificaciones:** Se utilizarán las fechas definidas en las certificaciones.
* **Seleccionar fecha:** Seleccionar una fecha específica (inicio, vencimiento) para esta asignación de certificación.';
...
$string['certifycertifieddate'] = 'Fecha de certificación';
$string['certifycertifieddate_help'] = 'Seleccione una fecha de certificación para este usuario entre \'Ahora\' (la certificación del usuario se certificará inmediatamente) o una fecha personalizada en el pasado.';
...
$string['errorcertificationdateinfuture'] = 'La fecha de certificación debe ser pasada.';
...
$string['errorexpirydatepreviouscertifieddate'] = 'La fecha de vencimiento no puede ser anterior a la fecha de certificación';
...
$string['errorinvalidpastduedate'] = 'La fecha de vencimiento no puede ser anterior a la fecha de inicio';
...
$string['errormissingexpirydate'] = 'Falta la fecha de vencimiento';
