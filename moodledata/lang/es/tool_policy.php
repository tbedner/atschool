...
/**
 * Strings for component 'tool_policy', language 'es', version '4.4'.
 *
 * @package     tool_policy
 * @category    string
...
$string['idontagree'] = 'No doy mi consentiemiento a {$a}.';
...
$string['privacy:metadata:subsystem:corefiles'] = 'La herramienta de políticas almacena ficheros incluidos en el resumen y la política completa.';
