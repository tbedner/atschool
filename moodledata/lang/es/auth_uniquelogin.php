...
/**
 * Strings for component 'auth_uniquelogin', language 'es', version '4.4'.
 *
...
$string['auth_uniquelogerror'] = 'Ya hay una sesión activa, por lo que no es posible acceder.';
...
$string['configaplly_to_admin'] = 'Aplicar la restricción para acceso único a usuarios con rol de Administrador en el contexto del sistema.';
$string['configaplly_to_teacher'] = 'Aplicar la restricción para acceso único a usuarios con rol de Profesor en cualquier curso Moodle.';
