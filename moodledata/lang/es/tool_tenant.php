...
/**
 * Strings for component 'tool_tenant', language 'es', version '4.4'.
 *
 * @package     tool_tenant
 * @category    string
...
$string['accountalreadyconfirmedinfo'] = '{$a} cuenta(s) salteada ya se encontraba confirmada';
$string['accountconfirmedfail'] = '{$a} cuenta(s) no fue encontrada o no puede ser confirmada';
$string['accountconfirmedsuccess'] = '{$a} cuenta(s) confirmada(s)';
$string['activetenants'] = 'Micrositios activos';
$string['activeusers'] = 'Activar cuentas de usuario';
...
$string['confirmaccounts'] = 'Confirmar cuentas';
$string['confirmactivateuser'] = '¿Estás seguro de querer activar este usuario?';
$string['confirmactivateusers'] = '¿Estás seguro de querer activar los usuarios seleccionados?';
...
$string['errornopermissionallocateusers'] = 'Permisos insuficientes para asignar usuarios a este micrositio';
$string['errortenantarchived'] = 'Este micrositio ha sido archivado';
$string['errortenantidnumberunique'] = 'El número de ID ya fue utilizado en otro micrositio';
...
$string['reg_wpsharedspaceenabled'] = 'El espacio compartido se encuentra habilitado ({$a})';
...
$string['unrecognisedaction'] = 'Acción no reconocida';
$string['unsuspenduser'] = 'Reactivar usuario';
$string['unsuspendusers'] = 'Usuarios reactivados';
$string['useractivatedsuccess'] = 'Usuario activado satisfactoriamente';
...
$string['usersactivatedfail'] = '{$a} usuario(s) no encontrado(s) o que no pudieron ser activados';
$string['usersactivatedsuccess'] = '{$a} usuario(s) activados';
