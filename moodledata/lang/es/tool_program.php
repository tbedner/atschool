...
/**
 * Strings for component 'tool_program', language 'es', version '4.4'.
 *
...
$string['allocatetoprograms'] = 'Asignar a programas...';
$string['allocateusers'] = 'Asignar usuarios';
$string['allocateuserstoprograms'] = 'Asignar usuarios a programas...';
...
$string['eventuserupdated'] = 'Método de asignación del usuario actualizado';
$string['existingcourses'] = 'Cursos existentes';
...
$string['name'] = 'Nombre';
$string['never'] = 'Nunca';
$string['newemptycourse'] = 'Nuevo curso vacío';
...
$string['programcompleted'] = 'Programa finalizado';
$string['programcompletiondate'] = 'Fecha de completud del programa';
$string['programdates'] = 'Fechas';
...
$string['set'] = 'Conjunto';
$string['setcompletiondate'] = 'Ajustar la fecha de completud';
