...
/**
 * Strings for component 'allocationform', language 'es', version '4.4'.
 *
...
$string['duplicateoption'] = 'Sus cambios no pudieron ser guardados en la base de datos. Esto muy probablemente sea debido a que se ha introducido un nombre de opción duplicado';
