...
/**
 * Strings for component 'block_vitrina', language 'es', version '4.4'.
 *
...
$string['commentsmanager_help'] = 'Elija el componente a usar para usar como los comentarios de los cursos.';
$string['commentsmodaltitle'] = 'Comentarios del curso';
$string['commentstitle'] = 'Comentarios más recientes';
$string['commentstitlealternate'] = 'Valoraciones del curso';
...
$string['enrollrequired'] = '¡Matricúlese para hacer el curso!';
$string['feeinfo'] = '{$a}';
...
$string['hascourseview'] = '¡Tiene acceso a este curso con su usuario actual!';
$string['htmlfooter'] = 'Pie de página del bloque';
...
$string['loadmore'] = 'Deseo ver más cursos';
...
$string['nomorecourses'] = 'Ha llegado al final';
$string['notenrollable'] = '¡Curso no disponible para nuevas matrículas!';
$string['notvisible'] = 'Este curso no está disponible';
$string['opendetailstarget'] = 'Abrir detalles en';
$string['opendetailstarget_blank'] = 'Nueva ventana';
$string['opendetailstarget_help'] = 'Elija dónde abrir la página de detalles del curso.';
$string['opendetailstarget_self'] = 'Misma ventana';
$string['paymentbutton'] = 'Pagar';
$string['paymentinfo'] = 'Métodos de pago disponibles para comprar el curso.';
...
$string['premiumcohort_help'] = 'La instancia de auto-matriculación debe estar asociada con la cohorte configurada para que se puedan matricular usuarios premium. Si no desea configurar la cohorte en cada curso no seleccione aquí una cohorte pero proteja la auto-matrícula con una clave para que no quede disponible para todos los usuarios.';
...
$string['premiumenrolledcourse'] = 'Curso para leer usuarios premium';
$string['premiumenrolledcourse_help'] = 'Los usuarios inscritos en el curso serán considerados usuarios premium.';
...
$string['ratingmanager'] = 'Gestor de la valoración';
...
$string['sharecoursedesc'] = '¿Conoce a alguien a quien le pueda gustar este curso?<br />
<strong>Háblele sobre él</strong>';
$string['shopmanager'] = 'Gestor de tienda';
$string['shopmanager_help'] = 'Elija el componente a usar como tienda.';
$string['showallcomments'] = 'Ver todos';
...
$string['staticfilters'] = 'Filtros estáticos';
$string['staticfilters_help'] = 'Seleccione los filtros fijos que se mostrarán en la vista de catálogo';
$string['summary'] = 'Resumen';
$string['summary_help'] = 'El contenido se muestra en la parte superior de la lista de cursos y en el detalle del curso.';
...
$string['tabtitle_recents'] = 'Próximos cursos';
$string['tabview'] = 'Vista de pestaña';
$string['tabview_help'] = 'Elija el diseño de las pestañas cuando esté disponible más de una vista';
