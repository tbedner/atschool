...
/**
 * Strings for component 'local_moodlemobileapp', language 'es', version '4.4'.
 *
...
$string['addon.mod_assign.multiplemarkersnotsupported'] = 'No se soportan múltiples marcadores aún en la app y no se puede modificar.';
...
$string['addon.mod_bigbluebuttonbn.moderatorhasjoinedlong'] = 'El moderador se ha unido. Ahora puede unirse usted a la sesión.';
$string['addon.mod_bigbluebuttonbn.moderatorhasjoinedshort'] = 'El moderador se ha unido.';
$string['addon.mod_bigbluebuttonbn.stillwaitingformoderator'] = 'Aún esperando que se una el moderador.';
...
$string['addon.tinymce.enabletinymceeditordescription'] = 'Un editor de texto avanzado con características de formato adicionales.';
$string['addon.tinymce.license'] = 'Moodle Pty Ltd ha otorgado una iicencia comercial TinyMCE compatbile con la licencia Apache 2.0.';
...
$string['core.connectandtryagain'] = 'Por favor, conéctese a internet e inténtelo de nuevo.';
...
$string['core.course.activityrequiresconnection'] = 'Esta actividad sólo está disponible con conexión a internet. Si su dispositivo está fuera de línea, no podrá acceder.';
...
$string['core.course.changesofflinemaybelost'] = 'Los cambios que haga en esta actividad mientras está fuera de línea no se guardarán.<br><br>Conecte su dispositivo a internet para evitar perder sus progresos.';
$string['core.course.confirmdownload'] = 'Está a punto de descargar {{size}}. {{availableSpace}} ¿Seguro que desea continuar?';
...
$string['core.howtoobtaincoordinates'] = 'Puede obtener sus coordenadas usando una app GPS o una <a href="{{url}}">app de mapas</a>.';
...
$string['core.leave'] = 'Salir';
$string['core.loadmore'] = 'Cargar más';
$string['core.locationnolongeravailable'] = 'Encontrar su ubicación ya no está disponible. {{howToObtain}}';
...
$string['core.login.morewaystologin'] = 'Más modos de autenticarse';
...
$string['core.needinternettoaccessit'] = 'Necesita conexión a internet para acceder.';
...
$string['core.notavailablecontentinapp'] = 'Este contenido no está disponible en la app, pero puede abrirlo en un navegador usando el siguiente botón.';
$string['core.notavailableoffline'] = 'Este contenido no está disponible fuera de línea. Por favor, conéctese a internet y vuelva a probar.';
...
$string['core.openinbrowserdescription'] = 'Será redirigido a una página web';
...
$string['core.reminders.noreminders'] = 'No se han programado recordatorios';
$string['core.reminders.reminderset'] = 'Recordatorio fijado para las {{$a}}';
$string['core.reminders.reminderunset'] = 'Recordatorio borrado';
$string['core.reminders.scheduledreminders'] = 'Recordatorios programados';
...
$string['core.settings.enablepinchtozoom'] = 'Habilitar pellizcar para hacer zoom';
...
$string['core.siteunavailablehelp'] = 'El sitio "{{site}}" no está disponible ahora. Por favor inténtelo nuevamente más tarde o póngase en contacto con su escuela o proveedor de aprendizaje.';
...
$string['core.user.limitedprofile'] = 'Este perfil es limitado';
$string['core.user.privateprofiledetails'] = 'Los detalles del perfil de usuario se mantienen privados para su rol o en los ajustes del sitio.';
...
$string['core.viewer.decreasetextsize'] = 'Disminuir tamaño de texto';
$string['core.viewer.editimage'] = 'Editar imagen';
$string['core.viewer.enterreadingmode'] = 'Entrar en modo de lectura';
$string['core.viewer.exitreadingmode'] = 'Salir del modo de lectura';
$string['core.viewer.fliphorizontally'] = 'Rotar horizontalmente';
$string['core.viewer.increasetextsize'] = 'Aumentar tamaño de texto';
$string['core.viewer.openreadingmodesettings'] = 'Abrir configuración de modo de lectura';
$string['core.viewer.qrscannerdeniedpermissionmessage'] = 'Por favor permita acceso a la cámara en la configuración de su dispositivo para usar el escáner de códigos QR.';
$string['core.viewer.qrscannerdeniedpermissiontitle'] = 'Denegado el permiso para usar la cámara.';
$string['core.viewer.qrscannerswitchtofrontcamera'] = 'Cambiar a la cámara delantera.';
$string['core.viewer.qrscannerswitchtorearcamera'] = 'Cambiar a la cámara trasera.';
$string['core.viewer.qrscannertitle'] = 'Escanear código QR';
$string['core.viewer.qrscannerturnofftorch'] = 'Encender la linterna';
$string['core.viewer.qrscannerturnontorch'] = 'Apagar la linterna';
$string['core.viewer.readingthemeauto'] = 'Emparejar app';
$string['core.viewer.readingthemedark'] = 'Oscuro';
$string['core.viewer.readingthemehcm'] = 'Alto contraste';
$string['core.viewer.readingthemelight'] = 'Luz';
...
$string['freemium.feature_pushnotificationsdevices'] = 'Dispositivos notificacines push';
...
$string['freemium.subscription_currentplan'] = 'Su plan actual';
$string['freemium.subscription_limitedfeatures'] = 'Características limitadas';
...
$string['freemium.subscriptionfeature_exceeded_custommenuitems'] = '{{ overflowCount }} elementos personalizados de menú están siendo ignorados';
...
$string['freemium.subscriptionplan_deprecated_message'] = 'Ya no ofrecemos Pro a nuevos clientes. Esto no afecta a su suscripción.';
$string['freemium.subscriptionplan_deprecated_title'] = 'Su plan Pro se mantiene igual';
$string['freemium.subscriptionplan_expired'] = 'Caducado';
$string['freemium.subscriptionplan_expireson'] = 'Expira en {{ date }}';
$string['freemium.subscriptionplan_free'] = 'Gratuito';
$string['freemium.subscriptionplan_manage'] = 'Gestionar suscripción';
$string['freemium.subscriptionplan_overlimits_message'] = 'Ha alcanzado los límites de su {{ plan }}. Mejore a Premium para quitar estos límites y mantener activas todas las características.';
$string['freemium.subscriptionplan_overlimits_title'] = 'Usted está por encima de los límites de su {{ plan }}.';
$string['freemium.subscriptionplan_upgrade'] = 'Mejore a Premium';
...
$string['freemium.upsell_batchdownloads_message'] = 'Ahorre tiempo descargando varios cursos a la vez.';
$string['freemium.upsell_batchdownloads_title'] = 'Mejore su plan para descargas en masa';
$string['freemium.upsell_coursedownload_managers_message'] = 'El plan {{ plan }} permite {{ limit }} cursos por dispositivo. Desbloquee descargas ilimitadas.';
$string['freemium.upsell_coursedownload_managers_title'] = 'Se ha alcanzado el límite de descarga de cursos';
$string['freemium.upsell_coursedownload_message'] = 'Su plan {{ plan }} permite un máximo de {{ limit }} descargas por dispositivo.';
$string['freemium.upsell_coursedownload_message_additional'] = 'Mejore su plan para dar a todos los usuarios descargas ilimitadas para acceso fuera de línea.';
$string['freemium.upsell_coursedownload_message_help'] = '¿Necesita más? Pida a su administrador características Premium.';
$string['freemium.upsell_coursedownload_title'] = 'Se ha alcanzado el límite de descargas';
$string['freemium.upsell_custommenuitem_info'] = 'El número de elementos personalizados permitido para su plan es {{ limit }}. Otros usuarios no pueden ver elementos personalizados adicionales.';
$string['freemium.upsell_custommenuitem_message'] = 'Mejore a Premium para añadir tantos enlaces personalizados como desee.';
$string['freemium.upsell_custommenuitem_title'] = 'Se ha alcanzado el límite de elementos del menú';
$string['freemium.upsell_fingerprintlogin_message'] = 'Mejore a Premium para ayudar a todos a acceder más rápido manteniendo a la vez su sitio seguro.';
$string['freemium.upsell_fingerprintlogin_title'] = 'Permitir acceso mediante huella digital';
$string['freemium.upsell_premiumplanrequired'] = 'Plan Premium requerido';
...
$string['freemium.upsell_unlockpremiumfeatures_message'] = 'Vea qué está perdiendo con un plan {{ plan }}';
$string['freemium.upsell_unlockpremiumfeatures_title'] = 'Desbloquear características Premium';
$string['freemium.upsell_unlockpremiumfeatures_yourplanlimit'] = 'Su plan';
$string['freemium.upsell_upgradeforunlimited'] = 'Mejore plan para no tener límites';
$string['freemium.upsell_upgradefreeaccept'] = 'Actualice';
$string['freemium.upsell_upgradefreemessage'] = 'Actualmente está usando el plan {{ plan }}. Mejore su plan para desbloquear más características.';
