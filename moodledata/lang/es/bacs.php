...
/**
 * Strings for component 'bacs', language 'es', version '4.4'.
 *
 * @package     bacs
 * @category    string
...
$string['advancedsettingsmessage1'] = 'Esta sección proporciona acceso directo para realizar operaciones complejas con los datos del concurso. Por ejemplo, copia rápida de concursos, depuración o configuración de tareas que no están presentes en la base de datos.';
$string['advancedsettingsmessage2'] = 'Tenga en cuenta que otros componentes no rastrean los cambios en estos campos y los sobrescribirán en la mayoría de las operaciones.';
$string['advancedsettingsmessage3'] = 'Use esto solo si sabe lo que está haciendo.';
...
$string['amountofpretests'] = 'Cantidad de tests previos';
...
$string['bacs:edit'] = 'Cambiar la configuración de cualquier concurso, volver a evaluar los envíos';
...
$string['configsybonapikey'] = 'La clave API de Sybon se utiliza para realizar envíos, obtener idiomas y obtener tareas';
...
$string['devirtualize'] = 'Desvirtualizar';
$string['devirtualizewarning'] = '¿Está seguro de que quiere eliminar la participación virtual? Los envíos de los usuarios NO se eliminarán. Los datos de participación virtual no se pueden restaurar.';
...
$string['diagnostics:task_pretests_msg'] = 'Comprobación de testsprevios de tareas. {$a->tasks_in_total} tareas en total / {$a->tasks_with_wrong_pretests_count} tareas con un número incorrecto de tests previos / {$a->tasks_with_wrong_pretests_index} tareas con numeración incorrecta de tests previos / {$a->tasks_without_pretests} tareas sin tests previos';
...
$string['generalnopermission'] = '¡No tiene permiso para esta operación!';
...
$string['pointsformissingtask'] = 'No se pueden cargar los puntos de la prueba para una tarea que falta.';
...
$string['privacy:metadata:bacs_submits:contest_id'] = 'ID del concurso donde se entregó el envío';
...
$string['privacy:metadata:bacs_submits_tests_output'] = 'Almacena las salidas de los envíos en los test previos';
...
$string['rejudge'] = 'Juzgar de nuevo';
$string['rejudgesubmits'] = 'Volver a juzgar envíos';
$string['rejudgesubmitsfor'] = 'Volver a juzgar envíos para:';
...
$string['submissionsspampenalty'] = '¡Has realizado demasiados envíos! Has realizado 50 envíos en los últimos 5 minutos. El envío de soluciones está temporalmente prohibido. Intenta recargar esta página más tarde.';
$string['submissionsspamwarning'] = '¡Estás realizando demasiados envíos! Si realizas 50 envíos en 5 minutos, perderás temporalmente la capacidad de enviar soluciones.';
...
$string['submitmessagetaskismissing'] = 'Esta tarea falta en la base de datos de Moodle. Elimine esta tarea de este concurso o actualice la información sobre las tareas disponibles.';
...
$string['taskofsubmitismissingincontest'] = 'La tarea (ID {$a->taskid}) de este envío falta en el concurso actual.
    Debes volver a añadir esta tarea al concurso si quieres que este envío se muestre correctamente.';
$string['taskofsubmitismissingincontestanddb'] = 'La tarea (ID {$a->taskid}) de este envío falta tanto en este concurso como en la base de datos de Moodle.
...
$string['virtualparticipationgeneralwarning'] = 'La participación virtual es la forma de participar en el concurso en un momento independiente.
