...
/**
 * Strings for component 'auth_antihammer', language 'es', version '4.4'.
 *
...
$string['auth_antihammer'] = 'Anti-insistente / Bloqueador de acceso';
...
$string['auth_antihammerdescription'] = 'Los usuarios no pueden acceder. Este módulo de autenticación sirve como un sistema de bloqueo para intentos de acceso';
...
$string['pluginname'] = 'Anti-insistente / Bloqueador de acceso';
$string['privacy:metadata:auth_antihammer'] = 'El método de autenticación antihammer almacena (temporalmente) información relacionada con intentos de acceso (recurrentes) para usuarios';
...
$string['privacy:metadata:auth_antihammer_log'] = 'El método de autenticación antihammer almacena información histórica / registros relacionados con intentos de acceso insistentes del usuario';
...
$string['promo'] = 'Plugin de autenticación anti-insistente / bloqueador de ingreso para Moodle';
