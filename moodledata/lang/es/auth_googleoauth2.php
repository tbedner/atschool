...
/**
 * Strings for component 'auth_googleoauth2', language 'es', version '4.4'.
 *
...
$string['auth_sign-in_with'] = 'Acceder con {$a->providername}';
$string['couldnotauthenticate'] = 'Falló la autenticación - Por favor intente acceder nuevamente.';
...
$string['supportmaintenance'] = 'Para apoyar el mantenimiento de este plugin, introduzca a <a target="_blank" href="https://moodle.org/plugins/view/auth_googleoauth2">Moodle.org plugin page</a> y elija "Add to my favourites". ¡Gracias!';
