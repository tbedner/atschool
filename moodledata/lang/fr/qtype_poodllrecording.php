...
/**
 * Strings for component 'qtype_poodllrecording', language 'fr', version '4.4'.
 *
...
$string['privacy:metadata'] = 'Le plugin Poodll Recording Question enregistre des données personnelles.';
