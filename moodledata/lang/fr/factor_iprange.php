...
/**
 * Strings for component 'factor_iprange', language 'fr', version '4.4'.
 *
...
$string['allowedipshasntmyip'] = 'Votre adresse IP (<i>{$a->ip}</i>) n’est pas dans la liste et vous ne passerez pas ce facteur.';
