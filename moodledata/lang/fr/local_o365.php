...
/**
 * Strings for component 'local_o365', language 'fr', version '4.4'.
 *
 * @package     local_o365
 * @category    string
...
$string['acp_tenants_intro'] = '<b> Fonctionnement de l’architecture mutualisée : </b> <br /> La mutualisation permet à plusieurs utilisateurs Office 365 d’accéder à votre site Moodle. <br /> <br />
    ...
    <ol>
        <li> Connectez-vous à Moodle en tant qu’utilisateur administrateur qui n’utilise pas le plugin d’authentification OpenID Connect. </li>
        ...
        <li> Une fois que vous avez ajouté tous les utilisateurs souhaités, réactivez le plugin d’authentification OpenID Connect dans Moodle. </li>
...
$string['settings_detectperms_details'] = 'Pour utiliser les fonctionnalités du plugin, des autorisations correctes doivent être configurées pour l’application dans Azure AD.';
