...
/**
 * Strings for component 'local_amos', language 'fr', version '4.4'.
 *
 * @package     local_amos
 * @category    string
...
$string['componentsstandard'] = 'Intégré';
...
$string['pluginclasscore'] = 'Sous-systèmes du cœur';
$string['pluginclassnonstandard'] = 'Plugins additionnels';
$string['pluginclassstandard'] = 'Plugins intégrés';
$string['pluginname'] = 'AMOS';
$string['plugintypelocations'] = 'Emplacement des types de plugin';
$string['plugintypelocations_desc'] = 'Permet de définir des emplacements pour des types de plugins additionnels, comme les types de sous-plugins fournis par des plugins intégrés, ou des types obsolètes.';
...
$string['standardcomponents'] = 'Liste des composants intégrés';
$string['standardcomponents_desc'] = 'Liste des composants intégrés à Moodle. Le nombre optionnel indique le code de la version depuis laquelle le composant est intégré. Si le nombre est négatif, il indique la dernière version pour laquelle le composant était intégré. Les deux nombres peuvent être présents. Exemples :

* `mod_workshop` - pas de nombre, ce composant est considéré comme intégré pour toutes les versions de Moodle
* `report_infectedfiles 310` - indique un composant devant être considéré comme intégré à partir de Moodle 3.10
* `theme_clean 25 -36` - indique que le composant était intégré de Moodle 2.5 jusqu’à Moodle 3.6 compris';
...
$string['stdvernotebetween'] = 'Intégré depuis {$a->from} jusqu’à {$a->to}';
$string['stdvernotefrom'] = 'Intégré depuis {$a->from}';
$string['stdvernoteto'] = 'Intégré jusqu’à {$a->to}';
...
$string['typecore'] = 'Sous-systèmes du cœur';
$string['typecorebadge'] = 'Cœur';
$string['typestandard'] = 'Plugins intégrés';
$string['typestandardbadge'] = 'Intégrés';
$string['unableenfixaddon'] = 'Les correctifs pour l’anglais ne sont acceptés que pour les plugins intégrés';
