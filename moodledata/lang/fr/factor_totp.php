...
/**
 * Strings for component 'factor_totp', language 'fr', version '4.4'.
 *
 * @package     factor_totp
 * @category    string
...
$string['settings:window_help'] = 'Durée de validité de chaque code. Vous pouvez augmenter cette valeur pour contourner les problèmes de connexion avec les appareils dont les horloges sont légèrement mal réglées. La valeur est arrondie aux 30 secondes le splus proches, qui est la durée avant génération de nouveaux codes.';
