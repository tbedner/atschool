...
/**
 * Strings for component 'zoom', language 'fr', version '4.4'.
 *
 * @package     zoom
 * @category    string
...
$string['modulename_help'] = 'Zoom permet aux enseignants de programmer des réunions récurrentes ou ponctuelles pour leurs cours.<br>Principales fonctionnalités&nbsp;:<br><ul><li><strong>Accès en un clic&nbsp;:</strong> Les étudiants rejoignent la réunion directement depuis Moodle sans avoir besoin d\'identifiants ou de codes d\'accès externes.</li><li><strong>Enregistrements&nbsp;:</strong> Offrez aux étudiants un accès facile aux enregistrements stockés dans le cloud une fois la session terminée. </li><li><strong>Suivi et notation&nbsp;:</strong> Suivez la participation des étudiants grâce à des rapports de présence automatiques.</li></ul>Exemples&nbsp;:<ul><li><strong>Cours en direct&nbsp;:</strong> Diffusez votre écran et utilisez le tableau blanc intégré pour illustrer des concepts complexes.</li><li><strong>Permanences virtuelles&nbsp;:</strong> Planifiez des sessions récurrentes « sans horaire fixe » pour permettre aux étudiants de se présenter à tout moment. </li><li><strong>Webinaires&nbsp;:</strong> Organisez des présentations à grande échelle avec une interaction contrôlée entre les participants.</li><li><strong>Salles de discussion&nbsp;:</strong> Favorisez la collaboration entre pairs lors des ateliers en direct.</li></ul><em>Remarque&nbsp;: nécessite un compte Zoom sous licence configuré par votre administrateur.</em>';
$string['modulename_summary'] = 'Créer et gérer des sessions de visioconférence Zoom directement depuis votre cours pour organiser des cours en direct, des webinaires ou des permanences virtuelles.';
$string['modulename_tip'] = 'Utiliser des réunions récurrentes avec le paramètre « Pas d\'heure fixe » pour créer un espace de travail virtuel réutilisable auquel les étudiants peuvent accéder tout au long du semestre.';
...
$string['setting_breakoutroom'] = 'Autoriser les salles de discussion pré-attribuées';
$string['setting_breakoutroom_help'] = 'L\'activation de cette option permettra de créer des salles de discussion pouvant être attribuées à l\'avance.';
