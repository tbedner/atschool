...
$string['actionrules_help'] = 'Les règles d\'action permettent de définir des conditions qui déterminent quand et combien de points sont attribués aux élèves.

Pour chaque action, les conditions sont évaluées dans l\'ordre où elles apparaissent à l\'écran. Dès qu\'une condition est remplie, les points correspondants sont attribués et les autres conditions de la même action ne sont plus évaluées.

Des limites peuvent être définies pour chaque condition. Lorsqu\'une condition a atteint sa limite, aucun point n\'est attribué et l\'action entière est ignorée.

[En savoir plus](https://docs.levelup.plus/xp/docs/action-rules?ref=blockxp_help)';
$string['actionrulesintro'] = 'Attribue des points aux élèves en fonction de leurs actions.';
...
$string['addaction'] = 'Ajouter action';
...
$string['admindefaultsettingsintro'] = 'Les réglages ci-dessous seront utilisés par défaut lorsque le bloc sera ajouté pour la première fois à un cours. Certains réglages peuvent être verrouillés ; dans ce cas, leur valeur sera strictement appliquée dans toutes les instances du plugin.';
...
$string['availabilityinfonotincourse'] = 'Doit s\'inscrire dans le cadre d\'un cours.';
...
$string['editlimits'] = 'Éditer les limites';
...
$string['eventsrulesintro'] = 'Suivre le déroulement des événements et attribuer des points aux élèves au fur et à mesure. Nous vous recommandons désormais d\'utiliser les nouvelles règles « Action » et « Achèvement ».';
...
$string['keeplogsdesc'] = 'La durée après laquelle les journaux sont supprimés de la base de données. Les journaux jouent un rôle important : ils servent à suivre les points attribués, à identifier l\'activité récente et à bien d\'autres fins. La suppression des journaux peut avoir une incidence sur la répartition des points au fil du temps.';
...
$string['noactionsyet'] = 'Aucune action pour l\'instant !';
$string['noactionsyetintro'] = 'Commencer en ajoutant une action à surveiller.';
...
$string['onceperquiz'] = 'Une fois par test';
...
$string['overalllimit_help'] = 'La limite globale définit le nombre maximal de fois où une condition peut rapporter des points.

Une fois cette limite atteinte, aucun point ne sera attribué pour cette action. Utiliser la limite globale pour contrôler le nombre maximal de fois où des points peuvent être attribués au cours d\'une période donnée.

[En savoir plus](https://docs.levelup.plus/xp/docs/action-rules/limits)';
$string['overalllimitdesc'] = 'La limite globale détermine le nombre de fois où une condition peut rapporter des points.';
...
$string['privacy:metadata:logs'] = 'Enregistrer le journal des points';
...
$string['privacy:path:userflags'] = 'Signalements des utilisateurs';
...
$string['reasonassignfeedbackread'] = 'Commentaire lu';
$string['reasonassignsubmitted'] = 'Devoir rendu';
$string['reasonchapterread'] = 'Chapitre lu';
$string['reasondatabaseentrycreated'] = 'Enregistrement créé dans la base de données';
$string['reasondiscussioncreated'] = 'Discussion créée';
$string['reasondiscussionread'] = 'Lire la discussion';
$string['reasondiscussionrepliedto'] = 'A répondu à la discussion';
$string['reasonfeedbackanswered'] = 'Réponse à votre commentaire';
$string['reasonglossaryentrypublished'] = 'Entrée du glossaire publiée';
$string['reasonlessoncontentviewed'] = 'Contenu de la leçon consulté';
$string['reasonlessonendreached'] = 'Leçon finie';
$string['reasonlessonstarted'] = 'Leçon commencée';
$string['reasonquizattemptfinished'] = 'Réponse au test terminée';
$string['reasonquizattemptstarted'] = 'Tentative de test débutée';
...
$string['repetitionlimit'] = 'Limite de répétitions';
...
La limite de répétition a pour but d\'empêcher les comportements abusifs et d\'encourager une participation plus large. Par exemple, dans un forum, il est possible de limiter les répétitions à une seule fois par discussion.

La limite globale et la limite de répétition s\'appliquent toutes les deux. Lorsque l\'une ou l\'autre de ces limites est atteinte, aucun point n\'est attribué.

[En savoir plus](https://docs.levelup.plus/xp/docs/action-rules/limits)';
$string['repetitionlimitdesc'] = 'La limite de répétition détermine à quel moment les utilisateurs peuvent répéter des actions similaires pour gagner à nouveau des points.';
$string['repetitionlimitset'] = 'Limite de répétitions définie';
...
$string['resultsfilteredforrulen'] = 'Résultats filtrés selon la règle « {$a} ».';
...
$string['rulefiltercmtag'] = 'Balise d\'activité';
$string['rulefiltercmtagdesc'] = 'Cette condition s\'appliquera si l\'activité comporte une balise spécifique.';
$string['rulefiltercmtagfield'] = 'Nom de la balise';
$string['rulefiltercmtaghelp'] = 'Saisir le nom de la balise exactement comme on le fait pour attribuer une balise à l\'activité.';
...
$string['ruletypeanswerfeedback'] = 'Répondre aux questions relatives aux commentaires';
$string['ruletypeanswerfeedbackdesc'] = 'Lorsque l\'utilisateur a répondu aux questions dans le cadre d\'une activité de retour d\'expérience.';
...
$string['ruletypecreatedatabaseentry'] = 'Créer une entrée dans la base de données';
$string['ruletypecreatedatabaseentrydesc'] = 'Lorsqu\'un utilisateur crée une nouvelle entrée dans une activité de base de données.';
$string['ruletypecreateforumdiscussion'] = 'Créer un sujet de discussion sur le forum';
$string['ruletypecreateforumdiscussiondesc'] = 'Lorsque l\'utilisateur crée une nouvelle discussion dans un forum.';
$string['ruletypefinishquizattempt'] = 'Terminer une tentative de test';
$string['ruletypefinishquizattemptdesc'] = 'Lorsque l\'utilisateur a terminé sa tentative de test.';
$string['ruletypeobtaincertificate'] = 'Obtenir un certificat';
$string['ruletypeobtaincertificatedesc'] = 'Lorsque l\'utilisateur se voit attribuer un certificat via l\'activité « Certificat personnalisé ».';
$string['ruletypepublishglossaryentry'] = 'Publier une entrée de glossaire';
$string['ruletypepublishglossaryentrydesc'] = 'Lorsqu\'une entrée du glossaire d\'un utilisateur est publiée.';
$string['ruletypereachlessonend'] = 'Atteindre la fin de la leçon';
$string['ruletypereachlessonenddesc'] = 'Lorsque l\'utilisateur atteint la fin d\'une activité de cours.';
$string['ruletypereadassignfeedback'] = 'Lire les commentaires sur le devoir';
$string['ruletypereadassignfeedbackdesc'] = 'Lorsque l\'utilisateur consulte les commentaires fournis à propos de son devoir rendu.';
$string['ruletypereadchapter'] = 'Lire le chapitre';
$string['ruletypereadchapterdesc'] = 'Lorsque l\'utilisateur ouvre le chapitre d\'une activité de lecture.';
$string['ruletypereadforumdiscussion'] = 'Lire la discussion sur le forum';
$string['ruletypereadforumdiscussiondesc'] = 'Lorsque l\'utilisateur consulte une discussion dans une activité de forum.';
$string['ruletypereplyforumdiscussion'] = 'Répondre à une discussion sur le forum';
$string['ruletypereplyforumdiscussiondesc'] = 'Lorsque l\'utilisateur a publié une réponse à une discussion sur le forum.';
...
$string['ruletypestartlesson'] = 'Commencer la leçon';
$string['ruletypestartlessondesc'] = 'Lorsque l\'utilisateur lance une activité leçon.';
$string['ruletypestartquizattempt'] = 'Commencer un test';
$string['ruletypestartquizattemptdesc'] = 'Lorsque l\'utilisateur commence une session dans un test.';
$string['ruletypesubmitassignment'] = 'Déposer un devoir';
$string['ruletypesubmitassignmentdesc'] = 'Lorsqu\'un utilisateur envoie un devoir.';
$string['ruletypeviewactivity'] = 'Afficher l\'activité';
$string['ruletypeviewactivitydesc'] = 'Lorsque l\'utilisateur accède à une page dans une activité.';
$string['ruletypeviewconsumecontent'] = 'Afficher le contenu';
$string['ruletypeviewconsumecontentdesc'] = 'De manière générale, lorsque l\'utilisateur consulte n\'importe quel type de contenu.';
$string['ruletypeviewcourse'] = 'Accéder à la page du cours';
...
$string['ruletypeviewlessoncontentdesc'] = 'Lorsque l\'utilisateur consulte le contenu d\'une page dans le cadre d\'une activité leçon.';
$string['ruletypeviewproducecontent'] = 'Rédiger du contenu';
$string['ruletypeviewproducecontentdesc'] = 'De manière générale, lorsque l\'utilisateur crée un contenu, quel qu\'il soit.';
...
$string['timesallowed'] = 'Temps impartis';
...
$string['unavailablebecause'] = 'Cette fonctionnalité n\'est pas disponible pour les raisons suivantes :';
...
$string['upgradetoaddmore'] = 'Passer à la version supérieure pour en ajouter davantage.';
...
$string['visitpagetoeditdefaultactionrules'] = 'Les règles d\'action constituent désormais la méthode recommandée pour définir des règles. Visiter [cette page]({$a}) pour personnaliser leurs paramètres par défaut.';
