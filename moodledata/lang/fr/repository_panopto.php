...
/**
 * Strings for component 'repository_panopto', language 'fr', version '4.4'.
 *
...
$string['bouncepageurlnotreadydesc'] = 'Visiter cette page après avoir enregistré la configuration du plugin pour rechercher l’URL de la page de rebond que vous devez utiliser dans les paramètres des fournisseurs d’identité Panopto.';
