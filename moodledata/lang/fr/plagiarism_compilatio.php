...
/**
 * Strings for component 'plagiarism_compilatio', language 'fr', version '4.4'.
 *
...
$string['activate_compilatio'] = 'Activer le plugin Compilatio';
...
$string['ai_included_in_subscription'] = 'Détection de texte généré par IA</li></ul>';
...
$string['always_enabled'] = 'Toujours activé';
...
$string['analysis_help'] = '<p>Vous avez deux options :
    ...
    Pour que tous les documents soient comparés les uns aux autres lors des analyses, attendez que tous les travaux soient soumis par les étudiants puis déclenchez les analyses.</p>';
$string['analysis_options'] = 'Options d’analyse :';
...
$string['configurable_detections_options'] = 'Options de détection configurables :';
...
$string['detection_ai_detection_activated'] = 'La détection IA est activée.';
$string['detection_ai_detection_configurable'] = 'La détection IA est configurable.';
$string['detection_ai_detection_desactivated'] = 'La détection IA est désactivée par l’administrateur.';
$string['detection_rewording_activated'] = 'La détection de reformulation est activée.';
$string['detection_rewording_configurable'] = 'La détection de reformulation est configurable.';
$string['detection_rewording_desactivated'] = 'La détection de reformulation est désactivée par l’administrateur.';
$string['detection_similarity_activated'] = 'La détection de similitude est activée.';
$string['detection_similarity_configurable'] = 'La détection de similitude est configurable.';
$string['detection_similarity_desactivated'] = 'La détection de similitude est désactivée par l’administrateur.';
$string['detection_unrecognized_text_language_activated'] = 'La détection des langues de texte non reconnues est activée.';
$string['detection_unrecognized_text_language_configurable'] = 'La détection des langues de texte non reconnues est configurable.';
$string['detection_unrecognized_text_language_desactivated'] = 'La détection des langues de texte non reconnues est désactivée par l’administrateur.';
...
$string['externalid'] = 'ID de document Compilatio';
...
$string['stats_aiscore'] = 'Score de texte rédigé par IA';
...
$string['stats_simscore'] = 'Score de similitude';
...
$string['stats_utlscore'] = 'Score de langue textuelle non reconnue';
...
$string['teacher_toolbox'] = 'Accéder à la boîte à outil de l’enseignant';
