...
/**
 * Strings for component 'board', language 'fr', version '4.4'.
 *
 * @package     board
 * @category    string
...
$string['Ok'] = 'OK';
$string['acceptedfiletypeforbackground'] = 'Types de fichiers acceptés pour les images d\'arrière-plan.';
$string['acceptedfiletypeforbackground_desc'] = 'Sélectionner les types de fichiers acceptés pour les images d’arrière-plan.';
$string['acceptedfiletypeforcontent'] = 'Types de fichiers acceptés pour les images de contenu.';
$string['acceptedfiletypeforcontent_desc'] = 'Sélectionner les types de fichiers acceptés pour le contenu.';
...
$string['allowed_singleuser_modes'] = 'Modes utilisateur unique activés';
$string['allowed_singleuser_modes_desc'] = 'Autoriser/interdire l\'utilisation de certains modes mono-utilisateur. N\'affecte pas les tableaux déjà créés';
...
$string['aria_column_locked'] = 'Colonne {$a} verrouillée';
$string['aria_column_unlocked'] = 'Colonne {$a} déverrouillée';
...
$string['board:post'] = 'Gérer ses propres publications et pouvoir évaluer d\'autres publications.';
$string['board:postcomment'] = 'Créer et afficher des commentaires sur les publications';
$string['board:view'] = 'Consulter le contenu du tableau.';
...
$string['close_button_text'] = 'Fermer';
...
$string['embed_allowed'] = 'Autoriser l\'intégration du tableau';
$string['embed_allowed_desc'] = 'Si elle est activée, la fonction d\'intégration du tableau est disponible dans les paramètres d\'activité.';
...
$string['event_delete_comment'] = 'Commentaire supprimé';
$string['event_delete_comment_desc'] = 'L\'utilisateur avec l\'ID « {$a->userid} » a supprimé le commentaire de publication avec l\'ID « {$a->objectid} » de la publication avec l\'ID « {$a->noteid} ».';
...
$string['export_backtoboard'] = 'Retour au tableau';
$string['export_board'] = 'Exporter le tableau';
$string['export_comment'] = 'Commenter';
$string['export_comments'] = 'Exporter les commentaires';
$string['export_comments_description'] = 'Veuillez choisir les commentaires que vous souhaitez exporter.';
$string['export_comments_include_deleted'] = 'Vous pouvez choisir d\'exporter tous les commentaires y compris ceux qui ont été supprimés.';
$string['export_comments_include_deleted_button'] = 'Exporter les commentaires (y compris supprimés)';
$string['export_content'] = 'Texte';
$string['export_deleted'] = 'Supprimé';
$string['export_email'] = 'Adresse de courriel';
$string['export_firstname'] = 'Prénom';
$string['export_heading'] = 'Intitulé du message';
$string['export_info'] = 'Titre du média';
...
$string['export_url'] = 'Lien URL du média';
...
$string['hidename'] = 'Masquer le nom du tableau intégré (nécessaire sur certains thèmes)';
...
$string['include_deleted'] = 'Inclure ce qui a été supprimé';
...
$string['privacystatement'] = '<strong>Déclaration de confidentialité de Tableau :</strong> Veuillez noter que les enseignants éditeurs et ceux disposant des autorisations appropriées peuvent afficher les données exportées indiquant quels utilisateurs ont créé les publications et commentaires de ce Tableau.';
$string['rate_note_text'] = 'Voulez-vous vraiment évaluer ce message ?';
$string['rate_note_title'] = 'Confirmer';
$string['rate_remove_note_text'] = 'Voulez-vous vraiment supprimer l\'évaluation de cette publication ?';
...
$string['settings:addattachmenttolog'] = 'Ajouter une pièce-jointe au journal';
$string['settings:addcolumnnametolog'] = 'Ajouter un nom de colonne au journal';
$string['settings:addcommenttolog'] = 'Ajouter un commentaire au journal';
$string['settings:addheadingtolog'] = 'Ajouter un titre au journal';
$string['settings:addnotetolog'] = 'Ajouter une note au journal';
$string['settings:addratingtolog'] = 'Ajouter une évaluation au journal';
$string['settings:enableprivacystatement'] = 'Activer la déclaration de confidentialité';
$string['settings:enableprivacystatement_desc'] = 'Afficher la déclaration de confidentialité dans la description du Tableau.';
$string['settings_heading_logging'] = 'Journalisation';
$string['settings_heading_logging_info'] = 'Par défaut, la journalisation contiendra du contenu, tel que le texte d\'une note, des commentaires, des noms de colonnes, etc.<br>À des fins de confidentialité des données, la journalisation peut être configurée pour exclure certaines informations soumises par les utilisateurs.';
...
$string['viewboard'] = 'Consulter l\'activité du tableau';
