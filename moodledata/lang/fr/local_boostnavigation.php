...
/**
 * Strings for component 'local_boostnavigation', language 'fr', version '4.4'.
 *
...
$string['setting_customnodesusagepleasenotecss'] = 'En raison de la façon dont le tiroir de navigation de Boost est construit dans le cœur de Moodle, les nœuds personnalisés ne peuvent pas être construit entièrement librement. L’ajout de classes CSS personnalisées, d’ID HTML personnalisés ou d’un attribut cible pour ouvrir le lien dans une nouvelle fenêtre est impossible.';
