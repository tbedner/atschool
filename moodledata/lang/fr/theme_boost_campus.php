...
/**
 * Strings for component 'theme_boost_campus', language 'fr', version '4.4'.
 *
...
$string['showsettingsincoursesetting_desc'] = 'Avec ce paramètre, vous pouvez modifier l’affichage des menus contextuels. Dans Boost, il y a un menu contextuel juste à côté de l’icône de rouage. En activant ce paramètre, les paramètres apparaissent directement sous l’en-tête du cours. Les paramètres sont organisés dans des onglets, il est donc plus facile pour l’utilisateur d’accéder au paramètre souhaité au lieu de parcourir une longue liste d’éléments de menu. Avec ce paramètre, nous masquons également l’icône des paramètres sur la page des participants car les entrées sur cette page sont dupliquées avec le menu du cours en cours et ne sont donc pas nécessaires. <br/>
Veuillez noter que cette modification n’affecte pas les utilisateurs qui ont désactivé javascript dans leur navigateur - ils obtiendront toujours le comportement du cœur de Moodle avec un menu contextuel de cours.';
