...
/**
 * Strings for component 'tool_coursearchiver', language 'fr', version '4.4'.
 *
...
$string['privacy:metadata:tool_coursearchiver'] = 'Données relatives aux utilisateurs qui se désinscrivent.';
$string['privacy:metadata:tool_coursearchiver_optout:userid'] = 'Identifiant de l’utilisateur qui s’est désinscrit.';
$string['privacy:metadata:tool_coursearchiver_optout_user'] = 'Données relatives aux utilisateurs qui se désinscrivent.';
