...
/**
 * Strings for component 'block_quickmail', language 'fr', version '4.4'.
 *
...
$string['altsendfrom_desc'] = 'Permettre les courriels secondaires (nécessite une modification du cœur pour cela).';
