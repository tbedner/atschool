...
/**
 * Strings for component 'auth_companion', language 'fr', version '4.4'.
 *
...
$string['error_empty_emaildomain'] = 'Erreur : domaine vide.';
$string['error_invalid_group'] = 'Erreur : groupe non valide !';
$string['error_wrong_emaildomain'] = 'Erreur : domaine de messagerie incorrect !';
$string['info_plugin_remains_deactivated'] = 'Le plugin reste désactivé';
...
$string['setting_emaildomain'] = 'Domaine de messagerie non utilisé';
$string['setting_emaildomain_help'] = 'Ce domaine sert à créer l\'adresse courriel temporaire de l\'utilisateur associé. Il doit s\'agir d\'un domaine auquel aucun courriel ne peut être envoyé.';
...
$string['setting_group_default'] = 'Paramètres par défaut du groupe';
