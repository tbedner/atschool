...
/**
 * Strings for component 'labnbook', language 'fr', version '4.4'.
 *
 * @package     labnbook
 * @category    string
...
$string['deleteActivityWithReport'] = 'Attention ! Des étudiants ont déjà commencé à travailler sur des rapports pour cette activité ! Si vous voulez supprimer cette activité dans Moodle, vous devez au préalable sur LabNBook, soit supprimer les rapports, soit archiver la classe correspondante';
...
$string['error_duplicate_teaming'] = 'Cette mission a déjà été attribuée dans le même contexte. Dans un cours, il n’est pas possible de créer plusieurs activités avec la même mission et le même groupe. Si vous ne parvenez pas à supprimer l’ancienne activité dans Moodle, allez dans LabNBook et archivez la classe qui correspond au groupe et à la mission de l’ancienne activité';
