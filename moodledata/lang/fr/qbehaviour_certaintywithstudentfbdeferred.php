...
/**
 * Strings for component 'qbehaviour_certaintywithstudentfbdeferred', language 'fr', version '4.4'.
 *
...
$string['lucidityindex_help'] = '<p>Cet indice évalue la cohérence entre la réussite perçue et la réussite réelle (en ignorant les réponses au hasard).</p><p>Plus cette valeur est grande et positive, plus cela indique que vous êtes sûr de vos réponses correctes et peu sûr de vos réponses incorrectes ; si cette valeur est négative, c’est un problème car vous semblez davantage certain de vos réponses incorrectes que de vos réponses correctes ! Enfin, si cette valeur est proche de zéro, cela signifie que vous êtes autant sûr de vos réponses correctes que de vos réponses incorrectes.</p><div><b>Valeur :</b> entre -100 et 100</div>';
$string['lucidityindex_nodi'] = 'Indice de lucidité';
$string['lucidityindex_nodi_help'] = '<p>Cet indice évalue la cohérence entre la réussite perçue et la réussite réelle.</p><p>Plus cette valeur est grande et positive, plus cela indique que vous êtes sûr de vos réponses correctes et peu sûr de vos réponses incorrectes ; si cette valeur est négative, c’est un problème car vous semblez davantage certain de vos réponses incorrectes que de vos réponses correctes ! Enfin, si cette valeur est proche de zéro, cela signifie que vous êtes autant sûr de vos réponses correctes que de vos réponses incorrectes.</p><div><b>Valeur :</b> entre -100 et 100</div>';
