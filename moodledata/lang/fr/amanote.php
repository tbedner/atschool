...
/**
 * Strings for component 'amanote', language 'fr', version '4.4'.
 *
 * @package     amanote
 * @category    string
...
2. *Le service Web mobile Moodle* est activé (Administration du site > Plugins > Services Web > Services externes)

3. Le protocole REST est activé (Administration du site> Plugins> Services Web> Gérer les protocoles)

4. Capacité *webservice/rest:use* est autorisée pour les *utilisateurs authentifiés* (Administration du site > Utilisateurs > Permissions > Définir les rôles > Utilisateurs authentifiés > Gérer les rôles)';
...
$string['showsize_help'] = 'Afficher la taille du fichier, par exemple « 3,1 Mo » à côté du lien vers la ressource.';
