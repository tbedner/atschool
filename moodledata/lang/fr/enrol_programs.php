...
/**
 * Strings for component 'enrol_programs', language 'fr', version '4.4'.
 *
...
$string['errorinvalidoverridedates'] = 'Remplacements de dates non valides';
...
$string['invalidallocationdates'] = 'Dates d\'attribution des programmes non valides';
$string['invalidcompletiondate'] = 'Date d\'achèvement du programme invalide';
$string['item'] = 'Élément';
...
$string['notification_allocation_description'] = 'Notification envoyée aux utilisateurs lorsqu\'ils sont affectés à un programme.';
...
$string['notification_deallocation_description'] = 'Notification envoyée aux utilisateurs lorsqu\'ils sont retirés du programme.';
...
$string['notification_due_description'] = 'Notification envoyée aux utilisateurs lorsque l\'achèvement de leur programme est en retard.';
...
$string['notification_duesoon_description'] = 'Notification envoyée aux utilisateurs avant la date d\'achèvement de leur programme, sauf si le programme est déjà achevé.';
...
$string['notification_endcompleted_description'] = 'Notification envoyée aux utilisateurs à la fin de leur programme.';
...
$string['notification_endfailed_description'] = 'Notification envoyée aux utilisateurs lorsque le programme qu\'ils n\'ont pas réussi à terminer prend fin.';
...
$string['notification_start_description'] = 'Notification envoyée aux utilisateurs lorsque leur programme a commencé.';
...
$string['programs:addtoplan'] = 'Ajouter le programme aux plans';
$string['programs:admin'] = 'Gestion avancée du programme';
$string['programs:allocate'] = 'Attribuer les programmes aux étudiants';
$string['programs:configframeworks'] = 'Configurer la disponibilité du programme dans les référentiels du plan';
...
$string['source_cohort_cohortstoallocate'] = 'Attribuer des cohortes';
...
$string['source_manual_timeduecolumn'] = 'Colonne des échéances';
$string['source_manual_timeendcolumn'] = 'Colonne de fin d\'heure';
$string['source_manual_timestartcolumn'] = 'Colonne de début d\'heure';
...
$string['source_udplans'] = 'Plans de développement des utilisateurs';
$string['source_udplans_allowed'] = 'Autorisé';
$string['source_udplans_noframeworks'] = 'Ne peut être ajouté à aucun plan';
$string['source_udplans_notallowed'] = 'Non autorisé';
$string['source_udplans_requirecap'] = 'Ajouter une capacité requise';
...
$string['userupload_completion_error'] = 'L\'achèvement du programme ne peut pas être mis à jour';
