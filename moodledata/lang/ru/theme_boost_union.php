...
$string['smartmenusrestrictbyadminheader'] = 'Ограничение видимости в зависимости от статуса администратора сайта';
...
$string['starredcourseslinktargetsetting_desc'] = 'С помощью этого параметра вы можете настроить цель ссылки значка шестеренки для курсов, отмеченных звездочкой (во всплывающем окне). По умолчанию значок шестеренки ссылается на страницу «Мои курсы». Однако вы также можете перейти по ссылке на страницу «Панель управления», особенно если вы отключили страницу «Мои курсы» в основной навигации.';
