...
/**
 * Strings for component 'subcourse', language 'ru', version '4.4'.
 *
 * @package     subcourse
 * @category    string
...
$string['settings:displayhiddencourses'] = 'Показать скрытые курсы';
$string['settings:displayhiddencourses_desc'] = 'Разрешить выбор скрытых курсов при редактировании субкурса.';
