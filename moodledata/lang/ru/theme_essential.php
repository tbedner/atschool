...
/**
 * Strings for component 'theme_essential', language 'ru', version '4.4'.
 *
...
<h4>PayPal</h4>
<p>Пожалуйста, свяжитесь со мной через мой <a href="https://moodle.org/user/profile.php?id=442195" target="_blank">профиль в Moodle</a> для получения подробностей, так как я — частное лицо и потому по  правилам PayPal не могу размещать кнопки \'buy me now\'.</p>
<h4>Flattr</h4>
...
<p>Если вам нравится эта тема и вы хотите, чтобы я изменил ее, перенес функциональность в другую тему или создал новую тему с нуля, я могу сделать это за определенную плату. Свяжитесь со мной через https://moodle.org/user/profile.php?id=442195 для обсуждения ваших требований.</p>
</div></div>';
