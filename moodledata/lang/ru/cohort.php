...
$string['visible_help'] = 'Любая глобальная группа может быть просмотрена пользователями, имеющими право «moodle/cohort:view» в контексте глобальной группы.<br/>
Видимые глобальные группы видны всем пользователям в соответствующих курсах.';
