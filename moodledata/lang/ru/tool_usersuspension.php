...
/**
 * Strings for component 'tool_usersuspension', language 'ru', version '4.4'.
 *
...
$string['csvencoding'] = 'Кодировка CSV';
$string['download-sample-csv'] = 'Скачать пример файла CSV';
...
$string['email:user:warning:body'] = '<p>Уважаемый(ая) {$a->name}</p>
<p>Ваша учетная запись будет заблокирована через {$a->warningperiod} по причине длительного отсутствия активности на платформе.</p>
<p>Вы должны выполнить вход в свою учетную запись в течение {$a->warningperiod} чтобы учетная запись осталась активной.
Чтобы этого не повторялось в будущем, пожалуйста, заходите в системы хотя бы каждые {$a->suspendinterval}.</p>
<p>С уважением,<br/>{$a->signature}</p>';
$string['email:user:warning:subject'] = 'Ваша учетная запись скоро будет заблокирована';
$string['err:statustable:set_sql'] = 'set_sql() отключен. Эта таблица не может быть настроена.';
$string['event:user:suspended'] = 'Пользователь заблокирован.';
...
$string['msg:user:suspend:nosuspendmode'] = 'Пользователь «{$a->username}» не был заблокирован (запуск в тестовом режиме)';
...
$string['msg:user:unsuspend:nounsuspendmode'] = 'Пользователь «{$a->username}» не был разблокирован (запуск в тестовом режиме)';
$string['msg:user:unsuspend:success'] = 'Пользователь \'{$a->username}\' восстановлен';
$string['notifications:allok'] = 'Ваши настройки правильны. Глобальных проблем с конфигурацией не обнаружено';
...
$string['privacy:metadata:tool_usersuspension:userid'] = 'Первичный ключ пользователя, чей аккаунт был восстановлен';
...
$string['tab:notifications'] = 'Проверка конфигурации';
...
$string['unsuspend'] = 'Разблокировать';
