...
/**
 * Strings for component 'message_telegram', language 'ru', version '4.4'.
 *
...
$string['requirehttps'] = 'Сайт должен использовать HTTPS для работы вебхука Telegram.';
...
$string['setwebhook'] = 'Настройка вебхука Telegram';
