...
/**
 * Strings for component 'local_amos', language 'ja', version '4.4'.
 *
 * @package     local_amos
 * @category    string
...
* 送信 - あなたの投稿を公式言語保守者が公式言語パックに組み込むことができるようスタッシュを送信するためのフォームを開きます。';
...
* 非表示 - あなたに表示されないようプルリクエストをブロックします。';
$string['sourceversion'] = 'ソースバージョン';
$string['stage'] = 'ステージ';
$string['stageactions'] = 'ステージ操作';
$string['stageactions_help'] = '* ステージストリングを編集する - ステージ翻訳のみ表示されるようトランスレータフィルタ設定を変更します。
