...
/**
 * Strings for component 'xmldb', language 'ja', version '4.4'.
 *
 * @package     xmldb
 * @category    string
...
$string['duplicatefieldsused'] = '重複したフィールドが使用されています。';
$string['duplicatetablename'] = '同一名のテーブルが存在します。';
$string['fieldsusedinindex'] = 'このフィールドはインデックスとして使用されています。';
$string['incorrectkeyname'] = 'キー名が正しくありません。';
$string['incorrecttablename'] = '不正なテーブル名';
