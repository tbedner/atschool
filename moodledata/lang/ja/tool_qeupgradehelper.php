...
/**
 * Strings for component 'tool_qeupgradehelper', language 'ja', version '4.4'.
 *
...
$string['areyousuremessage'] = 'コース {$a->shortname} 内の小テスト「 {$a->name} 」 {$a->numtoconvert} 件の受験すべてのアップグレードを続けてもよろしいですか?';
...
$string['croninstructions'] = 'あなたは次の不完全なアップグレードを自動的にアップグレード完了にするため、cronを有効にできます。cronは1日のうちで設定された時間に (サーバのローカル時間に基づき) 実行されます。それぞれの実行時、cronは制限時間を使ってしまうまで多くの受験を処理した後、次の実行時間まで待機します。2.1へのアップグレード未完了を検知しない限り、cronが受験を処理することはありません。';
$string['cronprocesingtime'] = 'cron実行時の処理時間';
$string['cronsetup'] = 'cronを設定する';
$string['cronsetup_desc'] = '小テスト受験データを自動的に完全にアップグレードするため、あなたはcronを設定できます。';
$string['cronstarthour'] = '開始時間';
$string['cronstophour'] = '終了時間';
$string['extracttestcase'] = 'テストケースを抽出する';
$string['extracttestcase_desc'] = 'アップグレードテストに使用する単体テストの作成補助としてデータベースのサンプルを使用します。';
...
$string['listupgradedintro'] = 'すべてのアップグレードする必要のある古いデータを含んだ小テスト受験です。リセットした後、再度アップグレードできます。';
...
$string['pretendupgrade_desc'] = 'アップグレードでは次の3つを実施します: データベースから既存のデータを読み込む。そのデータをコンバートする。そして、コンバート済みデータをデータベースに書き込む。このスクリプトは最初の2つの処理をテストします。';
$string['questionsessions'] = '問題セッション';
$string['quizid'] = '小テストID';
$string['quizupgrade'] = '小テストアップグレードステータス';
$string['quizzesthatcanbereset'] = '次の小テストはあなたがリセットできる受験をコンバートしました。';
