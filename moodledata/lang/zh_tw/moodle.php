...
/**
 * Strings for component 'moodle', language 'zh_tw', version '4.4'.
 *
 * @package     moodle
 * @category    string
...
$string['coursesearch_help'] = '您可以同時使用多個關鍵字來搜尋。並以下列方法來改進您的搜尋：

* word -- 搜尋任何包含有此關鍵字的內容。
* +word -- 只有完全吻合這些關鍵字才會被找出來。
* -word -- 排除含有此關鍵字的結果。';
...
$string['makeavailablecmtitle'] = '啟用活動';
...
$string['moodlenet:sharetyperesource'] = '資源';
