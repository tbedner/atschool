...
/**
 * Strings for component 'admin', language 'zh_tw', version '4.4'.
 *
 * @package     admin
 * @category    string
...
若要指定一個非預設的埠(例如，port 25以外的)，你可以使用這 [server]:[port] 語法(例如\'mail.a.com:587\')。就安全性連結，port 465 常用在SSL，而 port 587 常用在TLS，若需要的話，在下方指定安全傳輸協定。
...
$string['lockoutthreshold_desc'] = '指定在幾次登入失敗之後，該帳號將被封鎖。這一功能常被用於防範阻斷服務攻擊。';
