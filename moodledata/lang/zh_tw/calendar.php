...
/**
 * Strings for component 'calendar', language 'zh_tw', version '4.4'.
 *
 * @package     calendar
 * @category    string
...
$string['confirmsubscriptiondelete'] = '您確定要刪除「{$a}」這個行事曆訂閱嗎？';
$string['copycalendarurl'] = '複製行事曆網址';
$string['copyurl'] = '複製網址';
$string['course'] = '課程';
$string['coursecalendar'] = '{$a}行事曆';
$string['coursecalendarlink'] = '課程行事曆';
...
$string['daily'] = '每日的';
$string['day'] = '天';
$string['dayeventsmany'] = '{$a->day}，共 {$a->num} 個事件';
$string['dayeventsnone'] = '{$a}，沒有事件';
$string['dayeventsone'] = '{$a}，1 個事件';
$string['daynext'] = '下一天';
$string['dayprev'] = '前一天';
...
$string['errorrrule'] = '傳入的重複規則似乎不正確。';
...
$string['eventsupdated'] = '已更新 {$a} 個事件';
$string['eventtime'] = '時間';
...
$string['eventtypesite'] = '網站';
$string['eventtypeuser'] = '用戶';
$string['eventview'] = '事件詳細資料';
$string['expired'] = '到期';
...
$string['more'] = '更多';
$string['moreevents'] = '另外 {$a} 個';
$string['namewithsource'] = '{$a->name} ({$a->source})';
$string['never'] = '從不';
$string['newevent'] = '新增事件';
$string['newmonthannouncement'] = '行事曆已切換為 {$a}。';
$string['nocalendarsubscriptions'] = '尚未訂閱任何行事曆。您想要{$a}';
$string['nocalendarsubscriptionsimportexternal'] = '目前尚未有行事曆訂閱。<a href="{$a}">匯入外部行事曆</a>';
$string['notitle'] = '無標題';
...
$string['requiresaction'] = '{$a} 需要處理';
$string['sat'] = '六';
$string['saturday'] = '星期六';
$string['showeventtype'] = '顯示{$a}個事件';
$string['shown'] = '已顯示';
$string['site'] = '網站';
$string['siteevent'] = '網站事件';
...
$string['subscriptionupdated'] = '「{$a}」行事曆訂閱已更新';
$string['sun'] = '日';
$string['sunday'] = '星期日';
$string['thu'] = '四';
$string['thursday'] = '星期四';
...
$string['viewupcomingactivitiesdue'] = '檢視即將到期的活動';
$string['wed'] = '三';
