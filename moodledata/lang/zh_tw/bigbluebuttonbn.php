...
/**
 * Strings for component 'bigbluebuttonbn', language 'zh_tw', version '4.4'.
 *
...
$string['config_general_description'] = '要設定 BigBlueButton，您可以使用您自己的 BigBlueButton 伺服器和憑證，或透過 <a href="https://registration-portal.blindsidenetworks.com/" target="_blank">Blindside Networks 註冊入口（在新視窗中開啟）</a> 取得憑證。';
...
$string['end_session_confirm'] = '確定要結束直播嗎？';
$string['end_session_confirm_title'] = '真的要結束直播嗎？';
$string['ends_at'] = '結束';
...
$string['mod_form_field_closingtime'] = '關閉';
...
$string['mod_form_field_openingtime'] = '開啟';
...
$string['starts_at'] = '開始';
$string['userlimitreached'] = '已達到直播中允許的使用者數。';
...
$string['view_error_unable_join_student'] = '無法連線至直播教室伺服器。';
...
$string['view_message_session_started_at'] = '活動開始時間';
...
$string['view_nojoin'] = '您沒有加入此會議的權限角色。';
