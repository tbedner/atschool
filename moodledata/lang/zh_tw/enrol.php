...
/**
 * Strings for component 'enrol', language 'zh_tw', version '4.4'.
 *
 * @package     enrol
 * @category    string
...
$string['ajaxxmoreusersfound'] = '找到超過 {$a} 位用戶';
...
$string['enrolmentupdatedforuser'] = '用戶「{$a->fullname}」的選課註冊已更新';
...
$string['eventuserenrolmentupdated'] = '用戶選課註冊已更新';
...
$string['expirythreshold_help'] = '用戶應在選課註冊到期前多久收到通知？';
...
$string['invalidenrolduration'] = '無效的選課註冊期間';
...
$string['nogroup'] = '沒有群組';
$string['noguestaccess'] = '訪客無法存取此課程，請先登入。';
$string['none'] = '無';
$string['notenrollable'] = '您無法自行加入此課程。';
...
$string['plugindisabled'] = '{$a} 選課註冊外掛已停用';
$string['privacy:metadata:user_enrolments'] = '選課註冊';
$string['privacy:metadata:user_enrolments:enrolid'] = '選課註冊外掛實例';
$string['privacy:metadata:user_enrolments:modifierid'] = '最後修改用戶選課註冊的用戶 ID';
$string['privacy:metadata:user_enrolments:status'] = '用戶在課程中的選課狀態';
$string['privacy:metadata:user_enrolments:tableexplanation'] = '核心選課註冊外掛用於儲存已註冊的用戶。';
$string['privacy:metadata:user_enrolments:timecreated'] = '用戶選課註冊建立時間';
$string['privacy:metadata:user_enrolments:timeend'] = '用戶選課註冊結束時間';
$string['privacy:metadata:user_enrolments:timemodified'] = '用戶選課註冊修改時間';
$string['privacy:metadata:user_enrolments:timestart'] = '用戶選課註冊開始時間';
$string['privacy:metadata:user_enrolments:userid'] = '用戶 ID';
...
$string['sendcoursewelcomemessage'] = '傳送課程歡迎訊息';
$string['sendcoursewelcomemessage_help'] = '將用戶或群組加入課程時，可寄送一封課程歡迎電子郵件。若由課程聯絡人(預設為教師)寄送，且該角色有多位用戶，則會由第一位被指派此角色的用戶寄出。';
...
$string['timeended'] = '結束時間';
$string['timeenrolled'] = '選課時間';
$string['timereaggregated'] = '重新彙整時間';
$string['timestarted'] = '開始時間';
$string['totalenrolledusers'] = '{$a}位用戶已經加入課程';
$string['totalotherusers'] = '{$a}位其它用戶';
$string['totalunenrolledusers'] = '已取消 {$a} 位用戶的選課';
$string['unassignnotpermitted'] = '您沒有權限在這一課程中取消角色';
$string['unenrol'] = '退選';
$string['unenrolconfirm'] = '您確定要將用戶"{$a->user}" (原先透過"{$a->enrolinstancename}"選課) 從課程 "{$a->course}" 中退選嗎？';
$string['unenrolleduser'] = '用戶“{$a->fullname}”已從課程中取消註冊';
$string['unenrolme'] = '我要退選';
$string['unenrolnotpermitted'] = '您沒有權限將此用戶從課程中退選。';
