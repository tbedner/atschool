...
/**
 * Strings for component 'tool_coursearchiver', language 'ar', version '4.4'.
 *
...
$string['coursearchiver_help'] = 'البحث عن المقررات الدراسية باستعمال المعايير الآتية: مطابقة الاسم المختصر، الاسم الكامل، المُعرَّف، مُعرَّف المقرر، تاريخ آخر وصول إلى المقرر، أو المقررات الدراسية الفارغة*
.\\n
...
*المقررات الدراسية المخفية هي تلك التي فيها 0 من الواجبات، 0 من الموارد، 0 من التصنيفات في سجل التقديرات، و 0 من عناصر التقييم في سجل التقديرات.';
