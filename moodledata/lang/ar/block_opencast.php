...
/**
 * Strings for component 'block_opencast', language 'ar', version '4.4'.
 *
...
$string['allowunassigndesc'] = 'إحذف واجب مسلسل المساقات للتحكم بحالة الإظهار في منتقي الملفات وقوائم المساقات. هذه الميزة متاحة فقط عندما يكون ممكناً وجود أحداث بدون مسلسلات في opencast. لطفاً، إسأل المشرف على نظام opencast قبل تفعيله.';
$string['appearance_overview_settingheader'] = 'صفحة الملخص';
...
$string['descriptionmdfd'] = 'وصف الحقل';
...
$string['heading_description'] = 'وصف الحقل';
$string['heading_name'] = 'اسم الحقل';
$string['htitle'] = 'العنوان';
$string['hvisibility'] = 'حالة الإظهار';
$string['importmode'] = 'وضع الاستيراد';
$string['importseries'] = 'استيراد السلسلة';
$string['importvideos_importbuttontitle'] = 'استيراد الفيديوهات';
$string['importvideos_importheading'] = 'استيراد الفيديوهات من مساق آخر';
$string['importvideos_settingenabled'] = 'السماح باستيراد الفيديو';
$string['importvideos_settingheader'] = 'استيراد الفيديوهات من مساقات أخرى';
$string['importvideos_settingmanualenabled'] = 'السماح باستيراد الفيديو يدويًا';
$string['importvideos_settings'] = 'استيراد ميزات الفيديوهات';
$string['importvideos_wizardstep1sourcecourse'] = 'استيراد الفيديوهات من هذا المساق';
$string['importvideos_wizardstep2coursevideos'] = 'استيراد هذه الفيديوهات';
$string['importvideos_wizardstepbuttontitlerunimport'] = 'استيراد الفيديوهات والعودة إلى الاستعراض';
...
$string['startworkflow_modal_description_title'] = 'وصف سير العمل';
