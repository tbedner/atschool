...
/**
 * Strings for component 'tool_policy', language 'ar', version '4.4'.
 *
 * @package     tool_policy
 * @category    string
...
$string['agreepolicies'] = 'ترجى الموافقة على السياسات التالية:';
...
$string['idontagree'] = 'لا أوافق على {$a}.';
...
$string['nopermissiontoagreedocs'] = 'لا صلاحية للموافقة على السياسات.';
...
$string['nopermissiontoagreedocsbehalf'] = 'لا صلاحية للموافقة على السياسات نيابة عن هذا المستخدم.';
$string['nopermissiontoagreedocsbehalf_desc'] = 'عذرًا ، ليس لديك الإذن المطلوب للموافقة على السياسات التالية نيابة عن {$a}:';
$string['nopermissiontoagreedocscontact'] = 'لمزيد من المساعدة:';
