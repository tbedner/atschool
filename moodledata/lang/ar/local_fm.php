...
/**
 * Strings for component 'local_fm', language 'ar', version '4.4'.
 *
 * @package     local_fm
 * @category    string
...
<p>الاختبارات مدرجة في رأس التقرير بمثابة رؤوس الأعمدة. أنقر اسم الاختبار لمعاينة ملخص نتائجه. الدرجة الخاصة بكل محاولة للطالب ظاهرة في سطر جديد ضمن الخلية المحاذية ضمن عمود الاختبار. أنقر على الدرجة لمعاينة محاولة الطالب. إفادتك بشأن محاولة الطالب تُعرض في صفحة مراجعة المحاولة.</p>
