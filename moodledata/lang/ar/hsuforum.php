...
/**
 * Strings for component 'hsuforum', language 'ar', version '4.4'.
 *
 * @package     hsuforum
 * @category    string
...
$string['confighiderecentposts'] = 'إجعله نعم لإيقاف عرض منشورات المنتدى الأخيرة في صفحة المقرر';
$string['configlongpost'] = 'أي منشور يزيد عن هذا الحد (مقاساً بالحروف غير المتضمنة لرموز HTML) يعتبر طويلاً. المنشورات المعروضة في صفحة واجهة الموقع، صفحات المساقات ذات النمط الاجتماعي، أو الملفات الشخصية للمستخدمين يتم تقصيرها إلى فاصل طبيعي في موضع ما بين قيمتي hsuforum_shortpost و hsuforum_longpost.';
...
$string['showrecent'] = 'عرض منشورات المنتدى الأخيرة في صفحة المقرر';
$string['showrecent_help'] = 'عند تمكينه، فسيعرض منشورات المنتدى الأخيرة في صفحة المقرر.';
