...
/**
 * Strings for component 'turnitintool', language 'ar', version '4.4'.
 *
...
$string['autorefreshgrades'] = 'تنشيط الدرجات/التقديرات تلقائياً';
...
$string['modulename_help'] = 'يُنشئ واجب مباشر بين مودل و Turnitin وهو يربط نشاطًا في مودل مع واجب أو واجبات في Turnitin. بمجرد الارتباط، يسمح النشاط للمرشدين بتقييم وتوفير إفادة بشأن أعمال الطلاب الكتابية باستعمال أدوات التقييم المتاحة ضمن معاين المستندات في Turnitin.';
$string['nogrades'] = 'لا، سأقوم بتنشيط درجات الأصالة وتقديراتها يدوياً';
...
$string['previewwebpage'] = 'استعراض صفحة الويب';
...
$string['revealerror'] = 'ينبغي عليك تضمين سبب وجيه لإظهار اسم الطالب.';
...
$string['submissionprotocolerror'] = 'ينبغي عليك تضمين جزء http:// أو  https:// لعنوان الرابط لتسليم صفحة الويب هذا';
$string['submissionstudent'] = 'تسليم الطالب';
$string['submissiontexterror'] = 'ينبغي عليك تضمين النص لهذا التسليم';
...
$string['submissionurlerror'] = 'ينبغي عليك تضمين عنوان الرابط لتسليم صفحة الويب هذا';
...
$string['yesgrades'] = 'نعم، قم بتنشيط درجات الأصالة وتقديراتها تلقائياً';
