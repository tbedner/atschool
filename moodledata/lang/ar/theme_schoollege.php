...
/**
 * Strings for component 'theme_schoollege', language 'ar', version '4.4'.
 *
...
$string['defaultbackgroundimage_desc'] = 'هذه الصورة تستعمل في منطقة العنوان لكل صفحات مودل الرئيسية: لوحة التحكم، الملف الشخصي، الصفحة الرئيسية، كل الصفحات المجاورة لصفحات المقررات الدراسية.';
