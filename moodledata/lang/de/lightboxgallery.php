...
/**
 * Strings for component 'lightboxgallery', language 'de', version '4.4'.
 *
...
$string['makepublic_help'] = 'Eine öffentlich gemachte Galerie kann von allen Nutzer/innen (einschließlich Gästen) angezeigt werden, auch wenn sie nicht in den Kurs eingeschrieben sind.';
$string['metadata'] = 'Metadaten';
$string['modulename'] = 'Lightbox Galerie';
$string['modulename_help'] = 'Die Lightbox-Galerie erlaubt die Präsentation von Bildern in Moodlekursen.

Trainer/innen können Bildergalerien erstellen, bearbeiten und löschen.
Bilder können einzeln oder als Paket hochgeladen werden. Kleine Vorschaubilder werden automatisch erzeugt. Ein Klick auf ein Vorschaubild bringt das Bild in vergrößerter Darstellung in den Vordergrund. Die Lightbox-Scripts zeigen fließende Überblendeffekte beim Öffnen und Blättern.

In einer Lightbox-Galerie können Kommentare abgegeben werden, wenn die entsprechende Option aktiviert ist.';
...
$string['privacy:metadata:lightboxgallery_comments'] = 'Infos zu Kommentaren in einer bestimmten Lightbox-Galerie';
...
$string['search:activity'] = 'Lightbox-Galerie - Infos zur Aktivität';
...
$string['sortby_help'] = 'Hier können Sie die Reihenfolge festlegen, in der Bilder angezeigt werden sollen.';
$string['sortbycaption'] = 'Titel';
$string['sortbyfilename'] = 'Dateiname';
$string['sortbyfilenamenatural'] = 'Dateiname (natürliche Ordnung)';
$string['svgzunsupported'] = 'Komprimierte SVG Dokumente (.svgz) werden aktuell nicht unterstützt.';
