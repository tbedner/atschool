...
/**
 * Strings for component 'tool_moodlebox', language 'de', version '4.4'.
 *
...
$string['changepassworderror'] = 'Das System-Kennwort für den Terminalzugang und die Datenbank wurde nicht geändert, weil die Eingabefelder nicht übereinstimmen.';
$string['changepasswordmessage'] = 'Das System-Kennwort für den Terminalzugang und die Datenbank wurde geändert.<br /><br />Achtung: Das Moodle-Kennwort für das Nutzerkonto \'moodlebox\' <b>wurde nicht verändert</b>. Öffnen Sie dazu bitte die Moodle-Einstellungen für dieses Nutzerkonto.';
...
$string['documentation'] = 'MoodleBox-Dokumentation';
...
$string['forum_desc'] = '<p>Falls Sie keine Antwort auf Ihre Frage in der <a href="https://moodlebox.net/de/help/" title="MoodleBox-Dokumentation" target="_blank"> MoodleBox-Dokumentation </a> finden, suchen Sie bitte auch im <a href="https://discuss.moodlebox.net/" title="MoodleBox-Supportforum" target="_blank"> MoodleBox-Supportforum</a>. Möglicherweise ist Ihre Frage dort bereits beantwortet. Ansonsten können Sie dort gerne ein neues Thema beginnen.</p>';
...
$string['passwordsetting'] = 'System-Kennwort';
...
$string['rpi4threegb'] = 'Raspberry Pi 4B (3GB RAM)';
$string['rpi4twogb'] = 'Raspberry Pi 4B (2GB RAM)';
$string['rpi500'] = 'Raspberry Pi 500';
$string['rpi500plus'] = 'Raspberry Pi 500+';
...
$string['showdatetimebuttonsinfooter_desc'] = 'Wenn diese Option aktiviert ist, wird die Einstellung für Datum und Uhrzeit auf jeder Seite im Fußbereich angezeigt, wenn jemand als Administrator/in oder Manager/in angemeldet ist.';
...
$string['unsupportedhardware'] = 'Die Hardware wird nicht unterstützt! Dieses Plugin arbeitet nur mit einem Raspberry Pi.';
...
$string['wifipassword_help'] = 'Sie können das WLAN-Kennwort der MoodleBox ändern. Das Kennwort muss zwischen 8 und 63 druckbare ASCII-Zeichen haben. Das Kennwort darf Groß- und Kleinbuchstaben, Ziffern, Satzzeichen und auch Symbole enthalten.';
...
$string['wifissidinvalid'] = 'Der angegebene WLAN-Name (SSID) ist ungültig. Der Name kann zwischen 1 und 32 Bytes lang sein. Beachte, dass manche Zeichen (z.B. Emoticons) mehr als nur 1 Byte verwenden.';
