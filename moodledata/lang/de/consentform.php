...
/**
 * Strings for component 'consentform', language 'de', version '4.4'.
 *
 * @package     consentform
 * @category    string
...
$string['cssclassesstring'] = 'CSS Klassen für Bestätigungstext-Container';
$string['cssclassesstring_help'] = 'In diesem Textfeld können Sie Klassennamen angeben (z.B. Bootstrap-Klassen), die dem Container des Bestätigungstextes zugeordnet werden.';
...
$string['dependencies_description'] = 'Markieren Sie alle  Aktivitäten und Materialien, die für Teilnehmer/innen nicht zugänglich sein sollen, solange sie dieser Einverständniserklärung nicht zugestimmt haben.';
$string['dependent'] = 'Aktivitäten und Materialien';
...
$string['instancelistviewed'] = 'Instanzen-Liste betrachtet.';
$string['instancelistvieweddesc'] = 'Nutzer/in mit der ID {$a->userid} hat die Instanzenliste des Moduls mit der ID {$a->contextinstanceid} betrachtet.';
$string['linktexttomodulesettings'] = 'Link zu den Moduleinstellungen';
$string['listempty'] = 'Keine Einträge vorhanden.';
$string['listusers'] = 'Zustimmungen';
$string['listusersbutton'] = 'Alle Zustimmungen anzeigen';
$string['modulelistlinktext'] = 'Abhängigkeiten definieren';
...
$string['moduleviewed'] = 'Moduleinstiegsseite betrachtet.';
$string['modulevieweddesc'] = 'Nutzer/in mit ID {$a->userid} hat die Einstiegsseite des Moduls mit der ID {$a->contextinstanceid} betrachtet.';
...
$string['nocompletioncourselinktext'] = 'Link zu den Kurseinstellungen';
$string['nocompletionlinktext'] = 'Link zu mehr Informationen';
...
$string['nocompletionmodulelinktext'] = 'Link zu den Moduleinstellungen';
