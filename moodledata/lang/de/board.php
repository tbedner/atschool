...
$string['allowyoutube_desc'] = 'Wenn die Option aktiviert ist, wird eine Taste zum Hinzufügen eines eingebetteten YouTube-Videos angezeigt.';
...
$string['blanktargetenabled'] = 'Dieses Board wurde so konfiguriert, dass URLs in einem neuen Fenster oder Tab göffnet werden.';
$string['board:addinstance'] = 'Neues Board hinzufügen';
$string['board:deleteallcomments'] = 'Kommentare zu Beiträgen anzeigen und löschen';
$string['board:manageboard'] = 'Spalten und alle Beiträge verwalten';
$string['board:post'] = 'Eigene Beiträge verwalten. Fremde Beiträge bewerten';
