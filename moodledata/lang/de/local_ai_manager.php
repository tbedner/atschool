...
/**
 * Strings for component 'local_ai_manager', language 'de', version '4.4'.
 *
...
$string['ai_manager:manage'] = 'KI-Manager-Einstellungen für einen Tenant vornehmen';
$string['ai_manager:managetenants'] = 'KI-Manager-Einstellungen für alle Tenants vornehmen';
$string['ai_manager:managevertexcache'] = 'Abrufen und Verändern der Konfiguration des Google Vertex-AI-Caching-Status';
$string['ai_manager:use'] = 'KI-Manager benutzen';
$string['ai_manager:viewprompts'] = 'Nutzerprompts einsehen';
$string['ai_manager:viewpromptsdates'] = 'Zeitpunkte der Nutzerprompts sehen';
$string['ai_manager:viewstatistics'] = 'Statistiken sehen';
$string['ai_manager:viewtenantprompts'] = 'Nutzerprompts einsehen, die außerhalb von Kursen abgesetzt wurden';
...
$string['aicourseeditheader'] = 'KI-Funktionalitäten';
...
$string['changeconfirmstate'] = 'Zustimmung zu den Nutzungsbedingungen verändern';
$string['changelockstate'] = 'Gesperrt-Zustand verändern';
$string['changescope'] = 'Nutzungsumfang ändern';
$string['choosecontext'] = 'Wählen Sie den Bereich, für den die Nutzer/innen angezeigt werden sollen';
...
$string['confirmaitoolsusage_heading'] = 'Nutzung der KI-Funktionalitäten';
$string['confirmationstatuschanged'] = 'Der Zustand Ihrer Zustimmung wurde gespeichert';
$string['confirmed'] = 'akzeptiert';
$string['confirmtermsofuse'] = 'Ich akzeptiere die Nutzungsbedingungen und habe sie verstanden';
$string['consentdataprocessing'] = 'Ich willige in die o.g. Verarbeitung meiner personenbezogenen Daten ein';
$string['context'] = 'Kurs/Aktivität';
$string['contextdeleted'] = 'Bereits gelöscht';
$string['currentlyusedaitools'] = 'Aktuell konfigurierte KI-Tools';
$string['dataprocessingsetting'] = 'Einwilligung in die Datenverarbeitung';
$string['dataprocessingsettingdesc'] = 'Hier können Sie optional eine Einwilligung in die Datenverarbeitung hinterlegen.';
...
$string['error_confirmtermsofuse'] = 'Sie müssen den Nutzungsbedingungen zustimmen';
$string['error_consentdataprocessing'] = 'Sie müssen in die Einwilligung in die Datenverarbeitung einwilligen';
$string['error_http400'] = 'Fehler beim Bereinigen der übergebenen Optionen';
$string['error_http400contextmissing'] = 'Fehlender Kontext';
$string['error_http403blocked'] = 'Ihr Tenant-Manager hat den Zugriff auf die KI-Tools für Sie blockiert';
$string['error_http403coursesonly'] = 'Sie haben keine Berechtigung, KI-Tools außerhalb von Kursen zu verwenden';
$string['error_http403disabled'] = 'Ihr Tenant-Manager hat die KI-Tools für Ihren Tenant nicht aktiviert';
$string['error_http403nocapability'] = 'Sie haben keine Berechtigung, den KI-Manager zu nutzen';
$string['error_http403notconfirmed'] = 'Die Nutzung der KI-Funktionalitäten ist erst nach Bestätigung der Nutzungsbedingungen möglich';
...
$string['error_revokebothconfirmations'] = 'Sie müssen beiden oder keiner der Optionen zustimmen.';
...
$string['exception_tooldisabled'] = 'Der KI-Tool-Typ ist momentan durch den Administrator global deaktiviert. Sie dürfen ihn nicht bearbeiten.';
$string['exception_usernotexists'] = 'Der Nutzer existiert nicht.';
$string['executeaction'] = 'Aktion ausführen';
$string['executebulkuseractions'] = 'Aktion für ausgewählte Nutzer/innen ausführen';
...
$string['large'] = 'groß';
$string['lastday'] = 'Letzte 24 Stunden';
$string['lastmonth'] = 'Letzte 30 Tage';
$string['lastweek'] = 'Letzte 7 Tage';
$string['legalroles'] = 'Rollen, die rechtskräftig zustimmen können';
$string['legalrolesdesc'] = 'Wählen Sie Rollen für Nutzer/innen aus, die rechtskräftig Nutzungsbedingungen zustimmen können. Nutzer/innen mit diesen Rollen werden die Nutzungsbedingungen des Settings "termsofuselegal" statt denen des Settings "termsofuse" angezeigt und sie müssen der Einwilligung in die Datenverarbeitung des Settings "dataprocessing" zustimmen.';
$string['lock'] = 'Sperren';
...
$string['noprompts'] = 'Keine Prompts vorhanden';
$string['notconfirmed'] = 'Nicht zugestimmt';
...
$string['privacy_terms_description'] = 'Im Folgenden finden Sie Hinweise zu Datenschutz und die zusätzlichen Nutzungsbedingungen, die vor der Nutzung der KI-Funktionalitäten bestätigt werden müssen.';
...
$string['privacy_terms_missing_enable_anyway'] = 'Es gibt keine zusätzlichen Nutzungsbedigungen für die Nutzung von KI-Funktionalitäten. Aktivieren Sie den folgenden Schalter, um die KI-Funktionalitäten für Ihren Benutzer freizuschalten.';
$string['privilegedroles'] = 'Privilegierte Rollen';
$string['privilegedrolesdesc'] = 'Prompts von Nutzer/innen mit diesen Rollen im Systemkontext können von niemandem eingesehen werden einschließlich Tenant-Verwaltern. Zusätzlich werden diese Nutzer/innen nur anonymisiert in den Nutzerstatistiken angezeigt.';
$string['prompt'] = 'Prompt';
$string['promptcompletitionfilesnotavailable'] = 'Erzeugte Dateien werden in der Promptübersicht nicht angezeigt';
$string['promptsmodalheading'] = 'Prompts und Ergebnisse für Nutzer/in {$a->userDisplayName} im Bereich {$a->contextDisplayName}';
...
$string['resetuserusagetask'] = 'KI-Manager-Nutzungsdaten zurücksetzen';
...
$string['scope_courses'] = 'Nur innerhalb von Kursen';
...
$string['statistics_for'] = 'Statistik für {$a}';
$string['statisticsoverview'] = 'Gesamtübersicht';
$string['subpluginspageheading'] = 'KI-Manager-Subplugins';
...
$string['tenantcolumndesc'] = 'Die Spalte in der User-Tabelle, die den Bezeichner für den Tenant enthält, dem ein Nutzer hinsichtlich der KI-Tools zugeordnet werden soll';
$string['tenantconfig_heading'] = 'KI an Ihrem Tenant';
$string['tenantdisabled'] = 'deaktiviert';
$string['tenantenabled'] = 'aktiviert';
$string['tenantenabledescription'] = 'Damit Nutzer/innen Ihres Tenants alle KI-Funktionen der Moodle-Instanz vollständig verwenden können, müssen Sie die Funktion hier aktivieren und konfigurieren.';
...
$string['termsofuselegalsetting'] = 'Nutzungsbedingungen (mit rechtlicher Relevanz)';
$string['termsofuselegalsettingdesc'] = 'Sie können hier spezifische Nutzungsbedingungen für den KI-Manager hinterlegen. Im Vergleich zum Setting "termsofuse" sollte dieses Setting die Nutzungsbedingungen enthalten, denen Nutzer/innen rechtskräftig zustimmen können. Diese Nutzungsbedingungen werden nur Nutzer/innen angezeigt, die eine Rolle besitzen, die im "roleslegal"-Setting ausgewählt sind. Falls dieses Setting leer ist, werden die Nutzungsbedingungen aus dem Setting "termsofuse" benutzt.';
...
$string['unconfirmed'] = 'Nicht zugestimmt';
$string['unit_count'] = 'Anfrage(n)';
$string['unit_token'] = 'Token';
$string['unlock'] = 'Entsperren';
$string['unlockaitools'] = 'Ich möchte die KI-Funktionalitäten für mein Nutzerkonto freischalten';
$string['updatelist'] = 'Liste aktualisieren';
...
$string['userconfirmation_headline'] = 'Nutzung der KI-Funktionalitäten';
...
$string['viewprompts'] = 'Prompts anzeigen';
