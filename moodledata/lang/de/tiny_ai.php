...
/**
 * Strings for component 'tiny_ai', language 'de', version '4.4'.
 *
 * @package     tiny_ai
 * @category    string
...
$string['ai:view'] = 'KI-Schaltfläche anzeigen';
...
$string['copybutton'] = 'Kopieren';
$string['copybutton_tooltip'] = 'Aktuelles Ergebnis in die Zwischenablage kopieren';
...
$string['describe_headline'] = 'Ausführliche Beschreibung des Texts';
...
$string['downloadbutton'] = 'Herunterladen';
$string['downloadbutton_tooltip'] = 'Aktuelles Ergebnis als Datei herunterladen';
$string['error_filetypeclipboardnotsupported_text'] = 'Ihr Browser unterstützt das Kopieren dieses Dateityps in die Zwischenablage nicht';
$string['error_filetypeclipboardnotsupported_title'] = 'Nicht unterstützter Dateityp';
...
$string['error_unsupportedfiletype_title'] = 'Nicht unterstützter Dateityp';
...
$string['nopurposesconfigured'] = 'Es wurden keine KI-Tools konfiguriert. Wenden Sie sich an Ihren Tenant-Verwalter.';
$string['pluginname'] = 'KI-Tools';
$string['privacy:metadata'] = 'Dieses Plugin speichert keine personenbezogenen Daten.';
$string['prompt'] = 'Prompt';
$string['prompteditmode'] = 'Prompt-Bearbeiten-Modus';
$string['prompteditmode_tooltip'] = 'Prompt-Bearbeiten-Modus ein-/ausschalten';
$string['prompteditmodedisable'] = 'Prompt-Bearbeiten-Modus verlassen';
...
$string['summarize_headline'] = 'Zusammenfassen des Texts';
...
$string['translate_headline'] = 'Übersetzen des Texts';
$string['tts_headline'] = 'Audio aus Text generieren';
$string['voice'] = 'Stimme';
