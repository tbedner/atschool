...
$string['alerticoninfodesc'] = '设置在信息类型警告中使用的\'<a href="{$a}" target="_blank">Font Awesome 图标</a>\'。请输入不带 \'fa-\' 前缀的图标名称。';
$string['alerticonsuccess'] = '公告图标';
$string['alerticonsuccessdesc'] = '将 \'<a href="{$a}" target="_blank">Font Awesome Icons</a>\' 设置为公告类型提醒中使用的图标。输入图标名称时，请省略 \'fa-\' 前缀。';
$string['alerticonwarning'] = '警告图标';
$string['alerticonwarningdesc'] = '设置在警告类型提醒中使用的 \'<a href="{$a}" target="_blank">Font Awesome Icons</a>\'，请输入不带 \'fa-\' 前缀的图标名称。';
$string['alertinfo'] = '信息';
