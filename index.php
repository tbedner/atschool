						...
						<div class="inner">
							...
							<section style="margin: 1.5rem 0 2rem; padding: 1.5rem 1.5rem 1.75rem; border: 1px solid #e6e6e6; border-radius: 18px; background: #f8f9fb; box-shadow: 0 6px 18px rgba(0,0,0,0.04);">
								...
								<div style="display: flex; flex-wrap: wrap; gap: 0.75rem; justify-content: center;">
									...
									<a href="subscribe.php?lang=<?php echo htmlspecialchars($lang, ENT_QUOTES, 'UTF-8'); ?>" style="color:#fff;"><button type="button" class="btn btn-dark" style="padding: 0.75rem 1.25rem; font-weight: 700; border-width: 2px; box-shadow: 0 2px 8px rgba(0,0,0,0.08);"><?php echo htmlspecialchars($translations['home_jp_subscribe_button'], ENT_QUOTES, 'UTF-8'); ?></button></a>
								</div>
							</section>
							<?php endif; ?>
